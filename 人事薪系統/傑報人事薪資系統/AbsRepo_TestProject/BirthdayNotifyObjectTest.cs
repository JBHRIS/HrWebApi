...
namespace AbsRepo_TestProject
{
    ...
    /// <summary>
    ///這是 BirthdayNotifyObjectTest 的測試類別，應該包含
    ///所有 BirthdayNotifyObjectTest 單元測試
    ///</summary>
    [TestClass()]
    public class BirthdayNotifyObjectTest
    {
        ...
        {
            BirthdayNotifyObject target = new BirthdayNotifyObject(); // TODO: 初始化為適當值
            List<string> SourceRoleList = new List<string>(); // TODO: 初始化為適當值
            DateTime DateBegin = DateTime.Today;// new DateTime(2013, 05, 01); // TODO: 初始化為適當值
            DateTime DateEnd = DateTime.Today;//new DateTime(2013,05,31); // TODO: 初始化為適當值
