...
namespace JBHRIS.Api.Service.Interface.FlowMainInte
{
    public interface IFlowMainIntegrationHandleInterface
    {
        ...
        List<FlowViewCardRow> GetFlowViewCardByDept(int DeptaID = 0, bool ChildDept = false
            , int PageCurrent = 1, int PageRows = 100, string EffectDate = "", string DateB = "", string DateE = "", string FormCode = "0",
            string State = "0", int ProcessFlowID = 0, string Cond1 = "0", string Cond2 = "0", string Cond3 = "0", bool Handle = false);
        ...
        /// 取得目前待審核的表單-加班單
        /// </summary>
        /// <param name="ListNodeFinish"></param>
        /// <returns></returns>
