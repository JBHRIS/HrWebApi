...
{
    public class FormsAppAbscByProcessIdDao : BaseWebAPI<FormsAppAbscByProcessIdApiRow>
    {

        public FormsAppAbscByProcessIdDao() : base()
        {
            this.restURL = "/api/FormsAppAbsc/GetFormsAppAbsByProcessId";
        ...
        public async Task<APIResult> PostAsync(FormsAppAbscByProcessIdConditions Cond, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public APIResult Post(FormsAppAbscByProcessIdConditions Cond, CancellationToken cancellationToken = default(CancellationToken))
        {
            AuthenticationHeaderBearerTokenValue = Cond.AccessToken;
        ...
        public async Task<APIResult> GetDataAsync(FormsAppAbscByProcessIdConditions Cond, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public APIResult GetData(FormsAppAbscByProcessIdConditions Cond, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (Vdb.Status)
            {
                if (Vdb.Data != null)
                {
                    ...
                    {
                        var oSource = Vdb.Data as FormsAppAbscByProcessIdApiRow;
                        ...
                        if (oSource != null)
                        {
                            ...
                            if (oSource.state)
                            {
                                if (oSource.Result != null)
                                {
                                    ...
                                    var rsTarget = new FormsAppAbscByProcessIdRow();
                                    ...
                                    rsTarget.FlowApps = new List<FlowAbscData>();
                                    //把api的Data轉成我們的Data
                                    foreach (var rsFlowApps in rsSource.FlowApps)
                                    {
                                        var rFlowApps = new FlowAbscData();
