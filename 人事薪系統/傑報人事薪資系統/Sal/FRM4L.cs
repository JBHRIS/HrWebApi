...
namespace JBHR.Sal
{
    public partial class FRM4L : JBControls.JBForm
    {
        public FRM4L()
        {
            InitializeComponent();
        ...
        private void FRM4L_Load(object sender, EventArgs e)
        {
            ...
            this.eNRICHTableAdapter.FillByInit(this.salaryDS.ENRICH);
            ...
            fullDataCtrl1.DataAdapter = this.eNRICHTableAdapter;
        ...
        private void fullDataCtrl1_AfterAdd(object sender, JBControls.FullDataCtrl.AfterEventArgs e)
        {
            ...
            SystemFunction.SetComboBoxItems(cbFA_IDNO, CodeFunction.GetFA_IDNO(e.Values["nobr"].ToString()), true, true, true);
        }
        ...
        void GridBind()
        {
            foreach (var itm in this.salaryDS.ENRICH) itm.AMT = JBModule.Data.CDecryp.Number(itm.AMT);
            this.salaryDS.ENRICH.AcceptChanges();
        }
        ...
        private void btnChange_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show(Resources.Sal.DataChangeConfirm, Resources.All.DialogTitle, MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) == DialogResult.OK)
            {
                ...
                SalaryDS.ENRICHDataTable dtCompare = new SalaryDS.ENRICHDataTable();
                dtCompare.FillData(db.GetCommand(sql));
                foreach (var itm in this.salaryDS.ENRICH)
                {
                    try
                    {
                    ...
                    {
                        this.salaryDS.ENRICH.RejectChanges();
                ...
                this.eNRICHTableAdapter.Update(this.salaryDS.ENRICH);
                GridBind();//再加密
        ...
        private void ptxNobr_Validated(object sender, EventArgs e)
        {
            cbFA_IDNO.DataSource = null;
            cbFA_IDNO.Items.Clear();
            SystemFunction.SetComboBoxItems(cbFA_IDNO, CodeFunction.GetFA_IDNO(ptxNobr.Text), true, true, true);
