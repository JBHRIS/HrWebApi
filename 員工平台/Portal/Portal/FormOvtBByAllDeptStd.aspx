<%@ Page Title="" Language="C#" MasterPageFile="~/MainFlowFormsStd.master" AutoEventWireup="true" CodeBehind="FormOvtBByAllDeptStd.aspx.cs" Inherits="Portal.FormOvtBByAllDeptStd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
                        ...
                        <telerik:RadAjaxPanel ID="plAppS" runat="server">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-11">
                                    ...
                                    <asp:Label ID="lblIsHoliday" runat="server" Visible="false" Text=""></asp:Label>
                                    <asp:Label ID="lblOtTime" runat="server" Visible="false" Text=""></asp:Label>
                                    <asp:Label ID="lblRote" runat="server" Visible="false" Text=""></asp:Label>
                                    <asp:Label ID="lblAttCard" runat="server" Visible="false" Text=""></asp:Label>
                                </div>
    ...
    <asp:Label ID="lblDeptCodeAppMByDept" runat="server" Visible="False"></asp:Label>
