<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MainReportContentDeptEdit.aspx.cs" Inherits="Performance.MainReportContentDeptEdit" %>
                        ...
                        <telerik:RadAjaxPanel ID="plMain" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">
                                    <telerik:RadLabel ID="lblTitle" runat="server" />
                                    內容</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">排序</label>
                                <div class="col-sm-12">
                                    <telerik:RadNumericTextBox ID="txtSort" NumberFormat-DecimalDigits="0" MaxLength="3" Value="9" Skin="Bootstrap" MinValue="0" MaxValue="999" runat="server" Width="80" />
                                </div>
                            </div>
