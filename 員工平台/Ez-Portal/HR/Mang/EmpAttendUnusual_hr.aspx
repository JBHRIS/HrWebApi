<%@ Page Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true" CodeFile="EmpAttendUnusual_hr.aspx.cs" Inherits="HR_Mang_EmpAttendUnusual_hr" Title="出勤異常" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<table width="100%">
        <tr>
            <td valign="top">
            <h3>
                            <asp:Label ID="lblAtt" runat="server" Text="出勤異常" 
                            meta:resourcekey="lblAttResource1"></asp:Label>
                            </h3>
                        <fieldset>
                            <legend>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
                            ...
                            <br />
                            <asp:Label ID="Label2" runat="server" Text="查詢類別：" meta:resourcekey="Label2Resource1" 
                                ></asp:Label>
                            ...
                            <br />
                            <asp:Label ID="lblM" runat="server" Text="分鐘數：" 
                                meta:resourcekey="lblMResource1"></asp:Label>&nbsp;
                            &nbsp;<asp:TextBox ID="tbHrs" runat="server" meta:resourcekey="tbHrsResource1" 
                                Text="1"></asp:TextBox><br />
&nbsp;<asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="查詢" 
                            ...
                            <asp:CheckBox ID="cbExcludeRote" runat="server" Checked="True" Text="排除假日班" 
                                Visible="False" meta:resourcekey="cbExcludeRoteResource1" />

                        </fieldset>
                       <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False"
                            SkinID="Yahoo" AllowPaging="True" AllowSorting="True" 
                            OnPageIndexChanging="GridView2_PageIndexChanging" 
                            meta:resourcekey="gvResource1" onrowdatabound="gv_RowDataBound" 
                    Width="100%">
                            <Columns>
                                ...
                                <asp:BoundField DataField="LATE_MINS" HeaderText="遲到" 
                                    meta:resourcekey="BoundFieldResource5" />

                                <asp:BoundField DataField="E_MINS" HeaderText="早退" 
