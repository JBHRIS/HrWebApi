...
{
    public partial class ZZ2K : JBControls.JBForm
    {
        ZZ2K_Report zz2k_report;
        public ZZ2K()
        {
            InitializeComponent();
        }

        private void ZZ2K_Load(object sender, EventArgs e)
        {
            ...
            date_b.Text = JBHR.Reports.ReportClass.GetAttBDate(Convert.ToString(DateTime.Now.Year), Convert.ToString(DateTime.Now.Month));
            date_e.Text = JBHR.Reports.ReportClass.GetAttEDate(Convert.ToString(DateTime.Now.Year), Convert.ToString(DateTime.Now.Month));            
        }
        ...
        private void Create_Report_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                zz2k_report = new ZZ2K_Report(nobrb, nobre, empb, empe, deptb, depte, dateb, datee, type_data, _username, _exportexcel,MainForm.COMPANY_NAME);
                zz2k_report.Show();
