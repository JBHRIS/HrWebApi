<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AuthRole.aspx.cs" Inherits="Portal.AuthRole" %>
                            ...
                            <telerik:RadListView ID="lvMain" runat="server" RenderMode="Lightweight" ItemPlaceholderID="Container" OnItemCommand="lvMain_ItemCommand" OnNeedDataSource="lvMain_NeedDataSource">
                                ...
                                <ItemTemplate>
                                    <tr class="gradeX">
                                        ...
                                        <td><%# Eval("Name") %></td>
                                        <td>
                                            <asp:CheckBox runat="server" Checked='<%# Eval("IsAdminRole") %>' Skin="Bootstrap" Enabled="false" />
                                        </td>
                                        <td>
