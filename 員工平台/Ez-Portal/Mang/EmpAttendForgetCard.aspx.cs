...
public partial class Mang_EmpAttendForgetCard : JBWebPage
{
    ...
    void GetData()
    {
        ...
        if (obj.SelectedType == EnumUC_QS_SelectedType.Dept && !obj.IsSingleDept)
        {
            ...
            {
                attcardList.AddRange(attcardRepo.GetLostByDeptDateRange_Dlo(d, rdpBdate.SelectedDate.Value, rdpEdate.SelectedDate.Value));             
            }
        }
        ...
        //        attcardList.AddRange(attcardRepo.GetLostByDeptDateRange_Dlo(node.Value, rdpBdate.SelectedDate.Value, rdpEdate.SelectedDate.Value));                
        //}      
        //else
        //    attcardList.AddRange(attcardRepo.GetLostByDeptDateRange_Dlo(lb_dept.Text, rdpBdate.SelectedDate.Value, rdpEdate.SelectedDate.Value));


        //排除主管不可看部分
        attcardList.RemoveAll(p => Juser.ManagerExeptEmpList.Contains(p.NOBR));
