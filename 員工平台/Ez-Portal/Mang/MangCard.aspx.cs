...
using BL;
using JBHRModel;
public partial class Mang_MangCard : JBWebPage
{
    ...
    void GetData()
    {
        ...
        //{
        //    rv_cardDs.Merge(rv_card.GetData_rv_card(adate.SelectedDate.Value, ddate.SelectedDate.Value, "", lb_dept.Text));
        ...
        //    {
        //        rv_cardDs.Merge(rv_card.GetData_rv_card(adate.SelectedDate.Value, ddate.SelectedDate.Value, "", n.Value));
        //    }
        //}
        //else
        //{
        ...
        if (obj.SelectedType == EnumUC_QS_SelectedType.Emp) {
            ...
            {
                rv_cardDs.Merge(rv_card.GetData_rv_card(adate.SelectedDate.Value, ddate.SelectedDate.Value, "", n));
            }
        }
