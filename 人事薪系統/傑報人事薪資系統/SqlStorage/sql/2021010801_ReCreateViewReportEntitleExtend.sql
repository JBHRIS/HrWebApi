Drop view [dbo].[ReportEntitleExtend]
GO

/****** Object:  View [dbo].[ReportEntitleExtend]    Script Date: 2021/1/8 上午 10:06:27 ******/
SET ANSI_NULLS ON
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ReportEntitleExtend'
GO
