<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmpInfoState.ascx.cs"
    Inherits="Employee_EmpInfoState" %>
<h3>
    <asp:Label ID="lblInfo" runat="server" Text="在職資訊" meta:resourcekey="lblInfoResource1"></asp:Label>
</h3>
<asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" Text="狀態："
    meta:resourcekey="Label1Resource1"></asp:Label>
<asp:Label ID="lb_state" runat="server"
        Font-Size="Small" meta:resourcekey="lb_stateResource1"></asp:Label><br />
<asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Small" Text="年資："
    meta:resourcekey="Label3Resource1"></asp:Label>
<asp:Label ID="lb_year" runat="server"
        Font-Size="Small" meta:resourcekey="lb_yearResource1"></asp:Label><asp:GridView
