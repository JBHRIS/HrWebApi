<%@ Page Language="C#" MasterPageFile="~/MasterPage_OnlyContent.master" AutoEventWireup="true" CodeFile="Agent.aspx.cs" Inherits="Agent" Title="ezClient v1.0" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<span class="tag">請選擇欲設定的代理人：<asp:LinkButton ID="LinkButton1" runat="server" 
        PostBackUrl="~/WorkAgent.aspx" Visible="False" >工作代理人</asp:LinkButton>｜<asp:LinkButton ID="LinkButton2" runat="server" PostBackUrl="~/CheckAgent.aspx">簽核代理人</asp:LinkButton></span>
<h5>一、工作代理人(暫不開放)</h5>
