<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ManageMailTplBody.aspx.cs" Inherits="Performance.ManageMailTplBody" %>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <telerik:RadEditor runat="server" ID="txtSubject" SkinID="BasicSetOfTools" ContentAreaMode="Div"
                                        OnClientCommandExecuting="OnClientCommandExecuting" Width="100%" Height="80px" CssClass="form-control"
