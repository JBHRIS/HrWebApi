...
public partial class Ot1_Check : System.Web.UI.Page
{
    ...
    protected void gvAppS_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (ckSign != null)
        {
            ...
            //Label lblTotalHours = e.Row.FindControl("lblTotalHours") as Label;
            //if (lblTotalHours != null &&r.Any())
            //{
            //    var rr = r.FirstOrDefault();

            //    lblTotalHours.Text = JBHR.Dll.Att.OtHoursSum(rr.sNobr,JBHR.Dll.Att.SetYYMM(rr.dDateB.Date , "2" , 0 ), "2").ToString();
            //}
        }
    }
