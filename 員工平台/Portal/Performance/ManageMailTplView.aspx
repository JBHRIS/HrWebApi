<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ManageMailTplView.aspx.cs" Inherits="Performance.ManageMailTplView" %>
                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <telerik:RadAjaxPanel ID="plMain" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            ...
                            <telerik:RadButton ID="btnPrevious" runat="server" CommandArgument="-1" Text="上筆" CssClass="btn btn-primary" OnClick="btnPrevious_Click" />
                            <telerik:RadButton ID="btnNext" runat="server" OnClick="btnPrevious_Click" CommandArgument="1" Text="下筆" CssClass="btn btn-primary" />
