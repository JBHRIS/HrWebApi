<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmployeeContact.ascx.cs"
    Inherits="Employee_EmployeeContact" %>
<h3>
    <asp:Label ID="lblContact" runat="server" Text="通訊資料" meta:resourcekey="lblContactResource1"></asp:Label></h3>
<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White"
    BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1"
    Font-Size="X-Small" ForeColor="Black" GridLines="Vertical" Width="90%" meta:resourcekey="DetailsView1Resource1">
    <FooterStyle BackColor="#CCCC99" />
    <RowStyle BackColor="#F7F7DE" />
    <PagerStyle BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Right" />
    <Fields>
        <asp:BoundField DataField="gsm" HeaderText="手機" SortExpression="gsm" meta:resourcekey="BoundFieldResource1">
            <HeaderStyle Width="100px" />
        </asp:BoundField>
        <asp:BoundField DataField="email" HeaderText="eMail" SortExpression="email" Visible="False"
            meta:resourcekey="BoundFieldResource2" />
        <asp:BoundField DataField="tel1" HeaderText="戶籍電話" SortExpression="tel1" Visible="False"
            meta:resourcekey="BoundFieldResource3" />
        <asp:BoundField DataField="tel2" HeaderText="通訊電話" SortExpression="tel2" Visible="False"
            meta:resourcekey="BoundFieldResource4" />
        <asp:BoundField DataField="postcode1" HeaderText="戶籍郵政區號" SortExpression="postcode1"
            Visible="False" meta:resourcekey="BoundFieldResource5" />
        <asp:BoundField DataField="addr1" HeaderText="戶籍地址" SortExpression="addr1" Visible="False"
            meta:resourcekey="BoundFieldResource6" />
        <asp:BoundField DataField="postcode2" HeaderText="通訊地址區號" SortExpression="postcode2"
            Visible="False" meta:resourcekey="BoundFieldResource7" />
        <asp:BoundField DataField="addr2" HeaderText="通訊地址" SortExpression="addr2" Visible="False"
            meta:resourcekey="BoundFieldResource8" />
        <asp:BoundField DataField="province" HeaderText="戶籍地" SortExpression="province" Visible="False"
            meta:resourcekey="BoundFieldResource9" />
        <asp:BoundField DataField="born_addr" HeaderText="出生地" SortExpression="born_addr"
