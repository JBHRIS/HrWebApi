...
namespace JBHRIS.Api.Dal.ezFlow.ezEngineServicesImplement
{
    ...
    /// 
    /// </summary>
    public class CImage : ICImage_Dal
    {
        ...
        public CImage(ezFlowContext context)
        {
            this._context = context;         
        }

        public CImage(ezFlowContext context , ICData_Dal cData_Dal)
        {
            this._context = context;
        ...
        public Image FlowImage(int idProcess, int x = 0, int y = 0, int iWidth = 600, int iHeight = 0, bool bHeader = true)
        {
            ...
            var rProcessData = this._ICData_Dal.GetProcessData(lsProcess).FirstOrDefault();
