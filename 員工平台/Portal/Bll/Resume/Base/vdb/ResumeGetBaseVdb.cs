...
{
    public class ResumeBaseVdb
    {

    }

    public class ResumeGetBaseConditions : DataConditions
    {

    }

    public class ResumeGetBaseApiRow : StandardDataBaseApiRow
    {

    }
    public class ResumeGetBaseRow
    {
