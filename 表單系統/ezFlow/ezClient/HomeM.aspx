<%@ Page Language="C#" MasterPageFile="~/MasterPage_NoSubMenu.master" AutoEventWireup="true"
    CodeFile="HomeM.aspx.cs" Inherits="HomeM" Title="ezClient v1.0" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td align="right">
                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="使用電腦簽核" />
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Emp_name_Agent" HeaderText="簽核代理人" SortExpression="Emp_name_Agent">
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle Width="10%" />
                        </asp:BoundField>
