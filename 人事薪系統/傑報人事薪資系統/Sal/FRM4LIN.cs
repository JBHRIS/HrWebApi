...
namespace JBHR.Sal
{
    public partial class FRM4LIN : JBControls.U_FIELD
    {
        public FRM4LIN()
        {
            InitializeComponent();
        ...
        private void FRM4LIN_Load(object sender, EventArgs e)
        {
            cc = new CheckControl();
    ...
    public class ImportTransferToENRICH_N : JBControls.ImportTransfer
    {
