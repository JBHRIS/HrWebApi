    ...
    public partial class ZZ23_Report : JBControls.JBForm
    {
        ...
        private void ZZ23_Report_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlAbs = "select a.nobr,a.bdate,a.btime,a.etime,b.h_code_disp as h_code,b.h_name,b.not_sum,b.unit,a.tol_hours,datename(dw,a.bdate) as dw";
                ...
                sqlAbs += " and b.flag='-' and b.sort>0";
                if (reporttype == "5")
                    sqlAbs += "  and b.year_rest!='1'";
                else
                    ...
                    foreach (DataRow Row in rq_hcode.Rows)
                    {
                        ...
                        for (int i = 0; i < row2.Length; i++)
                        {
                            ...
                            if (row3 != null)
                            {
                                ...
                                row3["Fld" + _cnt] = decimal.Parse(row3["Fld" + _cnt].ToString()) + decimal.Parse(row2[i]["tol_hours"].ToString());
                            ...
                            else
                            {
                                ...
                                aRow2["Fld" + _cnt] = decimal.Parse(row2[i]["tol_hours"].ToString());
        ...
        void Export(DataTable DT)
        {
            ...
            ExporDt.Columns.Add("部門", typeof(string));
