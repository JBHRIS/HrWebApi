<%@ Page Title="" Language="C#" MasterPageFile="~/mpStd0990111.master" AutoEventWireup="true"
    CodeFile="Std.aspx.cs" Inherits="Ot1_Std" %>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    ...
                                    <asp:DropDownList ID="ddlDepts" runat="server" AppendDataBoundItems="True" DataSourceID="odsDepts"
                                        DataTextField="sDeptName" DataValueField="sDeptCode" OnDataBound="ddlRote_DataBound"
                                        ValidationGroup="fv" Visible="False">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlOtrcd" runat="server" AutoPostBack="True" DataSourceID="odsOtrcd"
                                        DataTextField="sOtrName" DataValueField="sOtrCode" ValidationGroup="fv">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:SqlDataSource ID="sdsAppS" runat="server" ConnectionString="<%$ ConnectionStrings:Flow %>"
                                        DeleteCommand="DELETE FROM [wfAppOt1] WHERE [iAutoKey] = @iAutoKey" SelectCommand="SELECT * FROM [wfAppOt1]
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:SqlDataSource ID="sdsFlow" runat="server" ConnectionString="<%$ ConnectionStrings:Flow %>"
                                                            SelectCommand="SELECT * FROM wfAppOt1
