<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmpBase.ascx.cs" Inherits="Mang_EmpBase" %>
<%@ Register Src="~/account/accountpicture.ascx" TagPrefix="uc" TagName="AccountPicture" %>

<h3>
    <asp:Label ID="lblBaseData" runat="server" Text="基本資料" meta:resourcekey="lblBaseDataResource1"></asp:Label>
</h3>
<table width="90%">
    <tr>
        ...
        <td valign="top">
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="LightGoldenrodYellow"
                ...
                Font-Size="X-Small" ForeColor="Black" GridLines="None" Width="100%" meta:resourcekey="DetailsView1Resource1">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HRSqlServer %>"
                SelectCommand="SELECT Nobr,name_c,name_e,    CASE sex WHEN 'M' THEN '男' WHEN 'F' THEN '女' ELSE '中性' END as sex,birdt,substring(idno,1,5)+'xxxxx' as idno FROM [base] WHERE ([Nobr] = @Nobr)">
                <SelectParameters>
