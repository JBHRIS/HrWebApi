<%@ Page Title="設定職能積分卡" Language="C#" MasterPageFile="~/mpTraining.master" AutoEventWireup="true"
    CodeFile="SetTrainingCard_manager.aspx.cs" Inherits="eTraining_Manager_SetTrainingCard_manager" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnlMember" runat="server" Visible="False">
            ...
            &nbsp;<asp:SqlDataSource ID="sdsGV" runat="server" 
                ConnectionString="<%$ ConnectionStrings:eLearningConnectionString %>" SelectCommand="select e.NAME_C,a.NOBR,dept.D_NAME,c.JOB_NAME,d.JOB_NAME,stu.OJT_sCode
from BASETTS a
...
">
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="lblDept" DefaultValue="-1" Name="dept" 
                        PropertyName="Text" />
                </SelectParameters>
            </asp:SqlDataSource>
            &nbsp;<br />
