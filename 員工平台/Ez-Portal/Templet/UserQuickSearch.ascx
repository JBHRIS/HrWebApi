...
<div style="font-size: x-small">
    ...
    姓名｜工號
        <telerik:RadTextBox ID="txtName" runat="server" Width="95px">
    </telerik:RadTextBox>
    <telerik:RadButton ID="btnSearchNobr" runat="server" Text="查詢" OnClick="btnSearchNobr_Click">
    </telerik:RadButton> 
    <%--<telerik:RadTextBox ID="txtName" runat="server" Width="60px">
    </telerik:RadTextBox>--%>
    &nbsp;<%--<telerik:RadButton ID="btnSearchNobr" runat="server" Text="查詢" OnClick="btnSearchNobr_Click">
    </telerik:RadButton> --%><telerik:RadFormDecorator ID="RadFormDecorator1" 
    ...
    <telerik:RadGrid ID="gvNobr" runat="server" AllowPaging="True" CellSpacing="0" 
        ...
        <MasterTableView DataKeyNames="Nobr">
            ...
            <Columns>
                <telerik:GridButtonColumn FilterControlAltText="Filter Select column" Text="選" UniqueName="Select"
                    CommandName="Select">
