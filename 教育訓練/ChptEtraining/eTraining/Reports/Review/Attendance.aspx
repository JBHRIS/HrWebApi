<%@ Page Title="課程出席率統計表" Language="C#" MasterPageFile="~/mpTraining.master" AutoEventWireup="true"
    CodeFile="Attendance.aspx.cs" Inherits="eTraining_Reports_Review_Attendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
        Height="600px" InteractiveDeviceInfos="(集合)" Visible="False" WaitMessageFont-Names="Verdana"
        WaitMessageFont-Size="14pt" Width="100%">
        <LocalReport ReportPath="eTraining\Reports\Review\Attendance.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>
