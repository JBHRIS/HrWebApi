    ...
    <div class="ibox-content">
        <telerik:RadAjaxPanel ID="plInfo" runat="server">
            <telerik:RadListView ID="gvAppS" runat="server" RenderMode="Lightweight" Skin="" ItemPlaceholderID="Container" OnNeedDataSource="gvAppS_NeedDataSource" OnItemCommand="gvAppS_ItemCommand" OnDataBound="gvAppS_DataBound">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col col-xs-6">
                                        <span><telerik:RadLabel runat="server" ID="lblOriginalWorkDateDic" Text="原上班日期"></telerik:RadLabel>：<%# Eval("DateB","{0:yyyy/MM/dd}") %></span><br>
                                        <span><telerik:RadLabel runat="server" ID="lblOriginalWorkClassDic" Text="原班別"></telerik:RadLabel>：<%# Eval("RoteNameB") %></span>
                                    </div>
                                    <div class="col col-xs-6">
                                        <span><telerik:RadLabel runat="server" ID="lblChangeWorkDateDic" Text="換班日期"></telerik:RadLabel>：<%# Eval("DateE","{0:yyyy/MM/dd}") %></span><br>
                                        <span><telerik:RadLabel runat="server" ID="lblChangeWorkClassDic" Text="換班班別"></telerik:RadLabel>：<%# Eval("RoteNameE") %></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="row">
                                    <div class="col col-xs-12">
                                        <span><telerik:RadLabel runat="server" ID="lblReasonDic" Text="原因" ></telerik:RadLabel>：<%# Eval("Note") %></span><br>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-1">
                ...
                <EmptyDataTemplate>
                    <telerik:RadLabel runat="server" ID="lblShiftShortEmptyMessageDic" Text="尚未新增換班資料"></telerik:RadLabel>
                </EmptyDataTemplate>
            </telerik:RadListView>
                    ...
                    <div class="ibox-content">
                        <telerik:RadAjaxPanel ID="plAppS" runat="server">
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <label class="col-form-label"><telerik:RadLabel runat="server" ID="lblOriginalWorkDateDic1" Text="原上班日期"></telerik:RadLabel></label>
                                ...
                                <div class="col-md-3">
                                    <label class="col-form-label"><telerik:RadLabel runat="server" ID="lblChangeWorkDateDic1" Text="換班日期"></telerik:RadLabel></label>
                            ...
                            <div class="form-group row">
                                <div class="col-md-3">
                                    <label class="col-form-label"><telerik:RadLabel runat="server" ID="lblOriginalWorkClassDic1" Text="目前班別"></telerik:RadLabel></label>
                                    <asp:Label ID="lblRoteA" runat="server" Skin="Bootstrap" Width="100%"></asp:Label>
                                </div>
                                <div class="col-md-3">
                                    <label class="col-form-label"><telerik:RadLabel runat="server" ID="lblChangeWorkClassDic1" Text="換班班別"></telerik:RadLabel></label>
                                ...
                                <div class="col-md-6">
                                    <label class="col-form-label"><telerik:RadLabel runat="server" ID="lblReasonDic1" Text="原因" ></telerik:RadLabel></label>
