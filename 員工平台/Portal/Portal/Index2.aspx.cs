...
namespace Portal
{
    public partial class Index2 : WebPageBase
    {
        ...
        public void index_DataBind()
        {
            ...
            //}
            lblListAbn.Text = oIndex.TodayAbnormal.AbnormalCount.ToString();
            lblListOt.Text = oIndex.OtHoursDateRangeList.OverTimeHours.ToString();
            ...
            lblOtHourBar.Style.Add(HtmlTextWriterStyle.Width, (Convert.ToDouble(lblOtHour.Text)*100/46).ToString() + "%");
