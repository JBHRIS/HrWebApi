...
public class Encrypt
{
    ...
    public static string EncryptInforamtion(string dataString)
    {
        ...
        return HttpUtility.UrlEncode(Convert.ToBase64String(returnVal), System.Text.Encoding.UTF8);
    }

    public static string DecryptInformation(string dataString)
    {
        var data = HttpUtility.UrlDecode(dataString, System.Text.Encoding.UTF8);
        ...
        Byte[] returnVal = AESDencrypt(Convert.FromBase64String(data), rijndael.CreateDecryptor(key, iv));
