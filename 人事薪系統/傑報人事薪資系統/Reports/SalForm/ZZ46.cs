    ...
    public partial class ZZ46 : JBControls.JBForm
    {
        ...
        private void Create_Report_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                zz46_report = new ZZ46_Report(nobrb, nobre, yyb, yye, monb, mone, seb, see, deptb, depte, compb, compe, workb, worke, empb, empe, typedata, reporttype, _excelexport, dateb, workadr, MedianMon, MainForm.USER_NAME, MainForm.COMPANY_NAME, MainForm.COMPANY);
                zz46_report.Show();
            }
            catch (Exception Ex)
            {
