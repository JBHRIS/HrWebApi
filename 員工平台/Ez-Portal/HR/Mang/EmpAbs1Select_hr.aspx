<%@ Page Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true"
    CodeFile="EmpAbs1Select_hr.aspx.cs" Inherits="HR_Mang_EmpAbs1Select_hr" Title="公出查詢"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
        ...
        <uc:EmpDeptQS runat="server" ID="ucEmpDeptQS" />
            ...
            <h3>
                <asp:Label ID="Label3" runat="server" Text="部門資料" meta:resourcekey="lblDeptResource1"></asp:Label>
            </h3>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <%--  <div class="SilverForm">
        ...
        <div class="SilverFormContent" style="color: red">
            <asp:Label ID="lblDetail1" runat="server" Text="1.主管查詢員工公出資料！" meta:resourcekey="lblDetail1Resource1"></asp:Label><br />
