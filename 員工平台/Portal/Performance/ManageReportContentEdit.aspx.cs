...
{
    public partial class ManageReportContentEdit : WebPageBase
    {
        ...
        public void LoadData(string Key)
        {
            ...
            var r = dcMain.PerformanceReportContent.FirstOrDefault(p => p.AutoKey == AutoKey);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (r != null)
            {
                ...
                oMainDao.MessageLog("1", "頁面：" + WebPage.GetActivePage + "｜名稱：" + WebPage.GetParentInfo() + "｜內容：" + JsonConvert.SerializeObject(r), "", "Performance-儲存報表內容", "", _User.UserCode);
