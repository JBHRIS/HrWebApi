...
namespace JBHR_CardTextCollector
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                JBModule.Data.Linq.U_SYS7_NS CardParms = null;
                ...
                var parms = from a in db1.U_SYS7_NS where a.AUTO == cardno select a;
                ...
                Dal.Dao.Att.TransCardDao_NS tc = new Dal.Dao.Att.TransCardDao_NS(db1.Connection);
    ...
    public class CardRead
    {
        ...
        public JBModule.Data.Linq.U_SYS7_NS CardParms = null;
        public CardRead(string record, JBModule.Data.Linq.U_SYS7_NS CardParms)
        {
            ...
            if (CardParms.TEXT_TYPE == "Position")
            {
                ...
                {
                    var baseRecord = db.BASE.Where(p => p.NOBR == nobr).Select(p => p.NOBR);
                    if (baseRecord.Any())
                        nobr = baseRecord.First();
                }
            }
            else
            {
        ...
        public DateTime Adate
        {
            get
            {
                ...
                if (Program.CardDatePattern.Trim().Length == 0)
                {
                    try
                    {
                ...
                else
                {
                    ...
                    if (DateTime.TryParseExact(date, Program.CardDatePattern, null, System.Globalization.DateTimeStyles.None, out dd))
                        return dd.Date;
                    else
        ...
        public string Atime
        {
            get
            {
                ...
                if (Program.CardTimePattern.Trim().Length == 0)
                {
                    if (tt.Length == 4)
                    {
                        int i = 0;
                ...
                {
                    DateTime dd = new DateTime();
                    if (DateTime.TryParseExact(tt, Program.CardTimePattern, null, System.Globalization.DateTimeStyles.None, out dd))
