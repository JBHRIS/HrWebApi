<%@ Page Title="" Language="C#" MasterPageFile="~/MainFlowFormsChk.master" AutoEventWireup="true" CodeBehind="FormShiftLongChk.aspx.cs" Inherits="Portal.FormShiftLongChk" %>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col col-xs-6">
                                            <span>調班日期：<%#Eval("Date") %></span><br>
                                            <span>原班別：<%#Eval("RotetNameOrigin") %></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <span>換班班別：<%#Eval("RotetName") %></span>
                                </div>
                            </div>
                                <div class="col-md-3">
                                    <div class="row">
                                        <div class="col col-xs-12">
                                            <span>原因：<%# Eval("Note") %></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1">
