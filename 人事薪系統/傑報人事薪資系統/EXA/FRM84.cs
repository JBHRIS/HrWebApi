...
namespace JBHR.EXA
{
	public partial class FRM84 : JBControls.JBForm
	{
		public FRM84()
		{
		...
		{
            // TODO: 這行程式碼會將資料載入 'exa.AssessCat' 資料表。您可以視需要進行移動或移除。
            this.assessCatTableAdapter.Fill(this.exa.AssessCat);
            fullDataCtrl1.DataAdapter = assessCatTableAdapter;
        ...
        {
            switch (fullDataCtrl1.EditType)
            {
                case JBControls.FullDataCtrl.EEditType.None:
                    break;
                case JBControls.FullDataCtrl.EEditType.Add:
                    textBox1.Text = "A";
                    break;
                case JBControls.FullDataCtrl.EEditType.Modify:
                    break;
                case JBControls.FullDataCtrl.EEditType.Deleted:
                    break;
                default:
                    break;
            }
