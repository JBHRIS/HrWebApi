...
{
    public partial class ZZ53 : JBControls.JBForm
    {
        ZZ53_Report zz53_report;
        public ZZ53()
        {
            InitializeComponent();
        }

        private void ZZ53_Load(object sender, EventArgs e)
        {
        ...
        private void Create_Report_Click(object sender, EventArgs e)
        {
            ...
            {               
                ...
                zz53_report = new ZZ53_Report(nobrb,nobre,deptb,depte,_year,sernob,sernoe,typedata,order_type,MainForm.USER_NAME,MainForm.COMPANY_NAME,MainForm.COMPANY);
                zz53_report.Show();
