<%@ Page Title="" Language="C#" MasterPageFile="~/mpTraining.master" AutoEventWireup="true"
    CodeFile="Role.aspx.cs" Inherits="eTraining_System_Role" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" Height="100%" 
        ...
        <table style="width: 100%;">
            <tr valign="top">
                <td style="width: 59%;">
                    <telerik:RadGrid ID="gvUserRole" runat="server" CellSpacing="0" Culture="zh-TW" GridLines="None"
                        OnItemDataBound="gvUserRole_ItemDataBound" Skin="Simple" OnSelectedIndexChanged="gvUserRole_SelectedIndexChanged"
                        OnNeedDataSource="gvUserRole_NeedDataSource">
                        <MasterTableView AutoGenerateColumns="False" DataKeyNames="iKey">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="sName" FilterControlAltText="Filter sName column"
                                    HeaderText="角色" SortExpression="sName" UniqueName="sName">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="iKey" DataType="System.Int32" FilterControlAltText="Filter iKey column"
                                    HeaderText="iKey" SortExpression="iKey" UniqueName="iKey" Visible="False">
                                </telerik:GridBoundColumn>
                            </Columns>
                            <EditFormSettings>
                    ...
                    <telerik:RadGrid ID="gvNobr" runat="server" AllowFilteringByColumn="True" AllowPaging="True"
                        ...
                        <MasterTableView DataKeyNames="NOBR">
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn DataField="sName" EmptyDataText="" FilterControlAltText="Filter sName column"
                                    HeaderText="角色" UniqueName="sName">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="iRoleKey" FilterControlAltText="Filter iRoleKey column"
                                    UniqueName="iRoleKey" Visible="False">
                                </telerik:GridBoundColumn>
                            </Columns>
                            <EditFormSettings>
                                <EditColumn FilterControlAltText="Filter EditCommandColumn column">
