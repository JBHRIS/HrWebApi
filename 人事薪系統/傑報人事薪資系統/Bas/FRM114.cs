...
namespace JBHR.Bas
{
	public partial class FRM114 : JBControls.JBForm
	{
		public FRM114()
		{
			InitializeComponent();
		...
		private void FRM114_Load(object sender, EventArgs e)
		{
			// TODO: 這行程式碼會將資料載入 'mainDS.WORKCD' 資料表。您可以視需要進行移動或移除。
            SystemFunction.CheckCodeConfigRule(btnCodeGroup);//**代碼權限設定**           
            this.wORKCDTableAdapter.Fill(this.basDS.WORKCD);

			fullDataCtrl1.DataAdapter = wORKCDTableAdapter;
            ...
            fullDataCtrl1.CodeColumn = "WORKCD.WORK_CODE";//**代碼權限設定**
            fullDataCtrl1.CodeSource = "WORKCD";//**代碼權限設定**
		}
