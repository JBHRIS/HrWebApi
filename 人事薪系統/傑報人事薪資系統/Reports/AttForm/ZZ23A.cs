...
{
    public partial class ZZ23A : JBControls.JBForm
    {
        ZZ23A_Report zz23a_report;
        public ZZ23A()
        {
            InitializeComponent();
        }

        private void ZZ23A_Load(object sender, EventArgs e)
        {
        ...
        private void Create_Report_Click(object sender, EventArgs e)
        {
            try
            {
                if (zz23a_report != null)
                {
                    zz23a_report.Dispose();
                    zz23a_report.Close();
                }
                ...
                zz23a_report = new ZZ23A_Report(nobrb, nobre, deptb, depte, compb, compe, hcodeb, hcodee, salarb, salare, yymmb, yymme, dateb, datee, checkrote, typedata, _lcstr, _reporttype, _exportexcel, _username,MainForm.COMPANY_NAME);
                zz23a_report.Show();
