...
public partial class ShiftShort_Check : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
            ...
            if (ckSign != null)
            {
                ...
                if (rAppS != null)
                {
                    ...
                    if (!rAppS.bSign)
                    {
                        ...
                        //發信通知被駁回的資料
                        //var rB = JBHR.Dll.Bas.EmpBase(rAppS.sNobrA).FirstOrDefault();
                        //if (rB != null && rB.sEmail.Trim().Length > 0)
                        //{
                        //    sSubTitle = "駁回通知";
                        //    sBody = rAppS.sNameA + "您好：<br>您" + lblTitle.Text + "被主管駁回了，原因：" + txtNote.Text + "。<br>特此通知。";
        ...
        rAppM.sConditions2 = lblNobrSign.Text; //最後簽核的人
