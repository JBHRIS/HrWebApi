...
{
    public partial class ZZ92 : JBControls.JBForm
    {
        ZZ92_Report zz92_report;
        public ZZ92()
        {
            InitializeComponent();
        }

        private void ZZ92_Load(object sender, EventArgs e)
        {
        ...
        private void Create_Report_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                zz92_report = new ZZ92_Report(compb, compe, deptb, depte, sub_b, sub_e, dateb, datee, type_data, reporttype, ExportExcel.Checked,MainForm.COMPANY_NAME);
                zz92_report.Show();
            }
            catch (Exception Ex)
            {
