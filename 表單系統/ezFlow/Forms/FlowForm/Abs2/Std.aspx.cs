...
public partial class Abs2_Std : System.Web.UI.Page
{
    ...
    private void txtHcode_DataBind()
    {
        ...
        var rsHcode = oHcodeDao.GetHocde("O" , false);
        ...
        //公出預設假別
        if (txtHcode.Items.FindItemByValue("O") != null)
        {
            txtHcode.ClearSelection();
            txtHcode.Items.FindItemByValue("O").Selected = true;
        }
    ...
    protected void Dialog_Click(object sender, EventArgs e)
    {
        ...
        if (btn != null)
        {
            ...
            Dialog(cn, lblAddGuid.Text);
        }
    }

    private void Dialog(string Case, string Key)
    {
        string DialogPage = "";
        ...
        switch (Case)
        {
            ...
            case "Flow":
                ...
                DialogParmDetail += "&NobrM=" + lblNobrAppM.Text;
                break;
            case "Calendar":
