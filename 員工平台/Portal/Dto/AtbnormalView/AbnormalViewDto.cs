...
namespace Dto.AbnormalView
{
    public class AbnormalViewDto : BaseWebAPI<AbnormalViewApiRow>
    {

        public AbnormalViewDto() : base()
        {
                            ...
                            if (oSource.state)
                            {
                                if (oSource.result != null)
                                {
                                    ...
                                    foreach (var rSource in rsSource)
                                    {
                                        ...
                                        rTarget.AbnormalDate = rSource.attendDate;
                                        rTarget.AbnormalType = rSource.abnormalName;
                                        rTarget.AbnormalMin = rSource.abnormalErrorMins;
                                        rTarget.RoteName = rSource.roteName;
                                        rTarget.CardTime = rSource.cardOnTime +"-"+rSource.cardOffTime;
                                        rTarget.Marked = rSource.remarkType;
