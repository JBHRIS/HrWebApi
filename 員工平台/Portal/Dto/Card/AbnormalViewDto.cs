...
namespace Dto.CardView
{
    public class CardViewDto : BaseWebAPI<CardViewApiRow>
    {

        public CardViewDto() : base()
        {
                            ...
                            if (oSource.state)
                            {
                                if (oSource.result != null)
                                {
                                    ...
                                    foreach (var rSource in rsSource)
                                    {
                                        ...
                                        rTarget.CardDate = rSource.puchInDate;
                                        rTarget.CardTime = rSource.puchInTime;
