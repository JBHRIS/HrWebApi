...
{
    public partial class ZZ2EB_Report : JBControls.JBForm
    {
        ...
        bool exportexcel;
        public ZZ2EB_Report(string nobrb, string nobre, string deptb, string depte, string workb, string worke, string compb, string compe, string dateb, string datee, string datet, string inout, bool _exportexcel, string reporttype, string _w8, string datatype, string compname)
        {
            InitializeComponent();
        ...
        private void ZZ2EB_Report_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlCmd1 += " and b.year_rest in ('5','6')";
                ...
                {                   
                    ...
                    if (report_type == "0")
                        RptViewer.LocalReport.ReportPath = _rptpath + "Rpt_zz2eb.rdlc";
                    else if (report_type == "1")
                        RptViewer.LocalReport.ReportPath = _rptpath + "Rpt_zz2eb1.rdlc";
        ...
        void Export(DataTable DT)
        {
            ...
            if (report_type == "0")
            {
                ...
                ExporDt.Columns.Add("彈休失效日", typeof(DateTime));
                ...
                foreach (DataRow Row in DT.Rows)
                {
                    ...
                    aRow["彈休失效日"] = DateTime.Parse(Row["edate"].ToString());
