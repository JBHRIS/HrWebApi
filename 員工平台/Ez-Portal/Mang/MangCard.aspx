<%@ Page Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true"
    CodeFile="MangCard.aspx.cs" Inherits="Mang_MangCard" Title="刷卡資料" Culture="auto"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
        ...
        <uc:EmpDeptQS runat="server" ID="ucEmpDeptQS" />
            ...
            <h3>
                <asp:Label ID="lblStaffSwipe" runat="server" Text="員工刷卡資料" meta:resourcekey="lblStaffSwipeResource1"></asp:Label></h3>
            <fieldset>
                <legend>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <%--    <div class="SilverForm">
        ...
        <div class="SilverFormContent" style="color: red">
            <asp:Label ID="Label3" runat="server" Text="1.主管查詢員工刷卡資料！" meta:resourcekey="Label3Resource1"></asp:Label>
            <br />
            <asp:Label ID="Label4" runat="server" Text="2.『部門資料』分三個選項：" meta:resourcekey="Label4Resource1"></asp:Label><br />
            &nbsp; &nbsp;
            <asp:Label ID="Label5" runat="server" Text="-員工：單一查詢每一個員工的相關資料" meta:resourcekey="Label5Resource1"></asp:Label><br />
            &nbsp; &nbsp;
            <asp:Label ID="Label6" runat="server" Text="-部門：查詢所選定的部門，所有員工的相關資料" meta:resourcekey="Label6Resource1"></asp:Label><br />
            &nbsp; &nbsp;
            <asp:Label ID="Label7" runat="server" Text="-含子部門：查詢所選定的部門及子部門，所有員工的相關資料" meta:resourcekey="Label7Resource1"></asp:Label><br />
            <asp:Label ID="Label8" runat="server" Text="3.『查詢條件』員工可以於條件中輸入區間日期，例 2008/01/01 至 2008/12/31 輸入完成之後，請按下『查詢』鍵，就可查詢員工相關資料！"
                meta:resourcekey="Label8Resource1"></asp:Label><br />
            <asp:Label ID="Label9" runat="server" Text="4.輸入日期格式為西元年！例 2008/12/31 ,也可點選欄位『日曆 圖案』可直接點選！"
