<%@ Page Language="C#" MasterPageFile="~/MasterPage_OnlyContent.master" AutoEventWireup="true" CodeFile="WorkAgent.aspx.cs" Inherits="WorkAgent" Title="ezClient v1.0" %>
	...
	<table bgcolor="whitesmoke" border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			<td style="height: 54px">
				...
				<asp:Label ID="Label8" runat="server" Font-Bold="True" Font-Size="Smaller" Text="(若您有多重身份，請為每個身份設定好代理人)"></asp:Label><br />
						...
						<td valign="top" width="50%">
							...
							<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete"
								...
								<SelectParameters>
									...
									<asp:SessionParameter Name="Emp_idSource" SessionField="Emp_id" Type="String" />
								</SelectParameters>
								<InsertParameters>
									<asp:Parameter Name="Role_idSource" Type="String" />
									<asp:Parameter Name="Emp_idSource" Type="String" />
