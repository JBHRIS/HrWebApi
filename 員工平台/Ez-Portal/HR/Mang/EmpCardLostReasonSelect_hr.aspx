<%@ Page Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="EmpCardLostReasonSelect_hr.aspx.cs" Inherits="Hr_Mang_EmpCardLostReasonSelect_hr"
                    ...
                    <td valign="top">
                        <h3>
                            <asp:Localize ID="Localize1" runat="server" 
                                meta:resourcekey="Localize1Resource1" Text="員工補卡原因"></asp:Localize>
                        </h3>
                        <fieldset>
                            <legend>查詢條件</legend>
