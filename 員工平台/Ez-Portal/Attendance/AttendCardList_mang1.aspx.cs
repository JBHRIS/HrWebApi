...
public partial class Attendance_AttendCardList_mang1 : JBWebPage
{
    ...
    void loadData() {
        ...
        TreeNode tvN= tv.FindNode(Juser.Dept);

        List<TreeNode> nodeList= new List<TreeNode>();
        if(tvN!=null)
            nodeList.AddRange(SiteHelper.GetChildNodes(tvN));
        ...
        foreach(var n in nodeList)
        {
            ...
            {
                atdt.Merge(attad.GetDataByDept(_adate, n.Value));
            }
        }
