<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Upload.ascx.cs" Inherits="Portal.Upload" %>
                    ...
                    <tr>
                        <td width="250px">
                            <div style="display: none;">
                                <telerik:RadAsyncUpload ID="fu" runat="server" CssClass="formItem" HttpHandlerUrl="~/HandlerArticleUpload.ashx"
                                    MultipleFileSelection="Automatic" Width="150px" />
                            </div>

                        </td>
                        <td>
                            <telerik:RadButton ID="btnUpload" runat="server"
                                Text="上傳">
                            </telerik:RadButton>
                        </td>
                    </tr>
...
<table style="padding: 30px;" width="100%">
    <tr>
        <td>
            <telerik:RadGrid ID="gvFiles" runat="server" CellSpacing="0" Culture="zh-TW" GridLines="None" OnNeedDataSource="gvFiles_NeedDataSource"
                OnItemCommand="gvFiles_ItemCommand" OnItemDataBound="gvFiles_ItemDataBound">
    ...
    <tr>
        <td>
            <telerik:RadButton ID="btnClose" runat="server" OnClientClicking="CancelEdit" Text="關閉" Visible="false">
            </telerik:RadButton>
        </td>
    </tr>
</table>
