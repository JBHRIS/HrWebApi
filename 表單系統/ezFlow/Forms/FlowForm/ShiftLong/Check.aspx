<%@ Page Title="" Language="C#" MasterPageFile="~/mpCheck0990119.master" AutoEventWireup="true"
    CodeFile="Check.aspx.cs" Inherits="ShiftLong_Check" %>
                    ...
                    <td>
                        <asp:GridView ID="gvAppS" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="sRotetNameA" HeaderText="原班別" 
                                    SortExpression="sRotetNameA" />
                                <asp:BoundField DataField="dDate" HeaderText="調班日期" SortExpression="dDate" 
                                    DataFormatString="{0:d}" />
                                <asp:BoundField DataField="sRotetName" HeaderText="調班別" 
