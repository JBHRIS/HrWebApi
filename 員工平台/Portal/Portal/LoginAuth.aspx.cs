...
namespace Portal
{
    public partial class LoginAuth : WebPageBase
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            if (Validate())
            {
                //lblmsg1.Text = "Valid Recaptcha";
                //lblmsg1.ForeColor = System.Drawing.Color.Green;
            }

            else
            {
                //lblmsg1.Text = "Not Valid Recaptcha";
            ...
            try
            {
                ...
                using (WebResponse wResponse = req.GetResponse())
                {
                    ...
                    using (StreamReader readStream = new StreamReader(wResponse.GetResponseStream()))
                    {
                        ...
                        LoginAuth data = js.Deserialize<LoginAuth>(jsonResponse);// Deserialize Json
