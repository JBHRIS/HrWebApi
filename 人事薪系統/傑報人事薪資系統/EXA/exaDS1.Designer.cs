...
namespace JBHR.EXA {
    ...
    public partial class exa : global::System.Data.DataSet {
        ...
        public partial class EFFEMPLOYDataTable : global::System.Data.TypedTableBase<EFFEMPLOYRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EFFEMPLOYRow AddEFFEMPLOYRow(string YYMM, string NOBR, string EFFTYPE, decimal EFFSCORE, string EFFLVL, bool IMPORT, System.DateTime KEY_DATE, string KEY_MAN, int AUTOKEY) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EFFEMPLOYRow FindByAUTOKEY(int AUTOKEY) {
        ...
        public partial class EFFEMPLOYRow : global::System.Data.DataRow {
            ...
            public string EFFTYPE {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("資料表 \'EFFEMPLOY\' 中資料行 \'EFFTYPE\' 的值是 DBNull。", e);
                    }
                }
                set {
            ...
            public int AUTOKEY {
                get {
                    return ((int)(this[this.tableEFFEMPLOY.AUTOKEYColumn]));
                }
                set {
                    this[this.tableEFFEMPLOY.AUTOKEYColumn] = value;
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bool IsEFFTYPENull() {
                return this.IsNull(this.tableEFFEMPLOY.EFFTYPEColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetEFFTYPENull() {
                this[this.tableEFFEMPLOY.EFFTYPEColumn] = global::System.Convert.DBNull;
            }
        }
...
SELECT EFFTYPE, EFFTYPE_DISP, EFFTYPE_NAME, KEY_DATE, KEY_MAN FROM EFFTYPE WHERE (EFFTYPE = @EFFTYPE) ORDER BY EFFTYPE_DISP";
    ...
    public partial class EFFEMPLOYTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [EFFEMPLOY] WHERE (([AUTOKEY] = @Original_AUTOKEY))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT YYMM, NOBR, EFFTYPE, EFFSCORE, EFFLVL, IMPORT, KEY_DATE, KEY_MAN, AUTOKEY FROM EFFEMPLOY WHERE (AUTOKEY = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [EFFEMPLOY] SET [YYMM] = @YYMM, [NOBR] = @NOBR, [EFFTYPE] = @EFFTYPE, [EFFSCORE] = @EFFSCORE, [EFFLVL] = @EFFLVL, [IMPORT] = @IMPORT, [KEY_DATE] = @KEY_DATE, [KEY_MAN] = @KEY_MAN WHERE (([AUTOKEY] = @Original_AUTOKEY));
SELECT YYMM, NOBR, EFFTYPE, EFFSCORE, EFFLVL, IMPORT, KEY_DATE, KEY_MAN, AUTOKEY FROM EFFEMPLOY WHERE (AUTOKEY = @AUTOKEY)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT  YYMM, NOBR, EFFTYPE, EFFSCORE, EFFLVL, IMPORT, KEY_DATE, KEY_MAN, AUTOKEY" +
                "\r\nFROM     EFFEMPLOY";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT  EFFLVL, EFFSCORE, EFFTYPE, IMPORT, KEY_DATE, KEY_MAN, NOBR, YYMM, AUTOKEY" +
                "\r\nFROM     EFFEMPLOY\r\nWHERE   (1 = 0)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string YYMM, string NOBR, string EFFTYPE, decimal EFFSCORE, string EFFLVL, bool IMPORT, System.DateTime KEY_DATE, string KEY_MAN, int Original_AUTOKEY, int AUTOKEY) {
            if ((YYMM == null)) {
                throw new global::System.ArgumentNullException("YYMM");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_AUTOKEY));
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(AUTOKEY));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string YYMM, string NOBR, string EFFTYPE, decimal EFFSCORE, string EFFLVL, bool IMPORT, System.DateTime KEY_DATE, string KEY_MAN, int Original_AUTOKEY) {
            return this.Update(YYMM, NOBR, EFFTYPE, EFFSCORE, EFFLVL, IMPORT, KEY_DATE, KEY_MAN, Original_AUTOKEY, Original_AUTOKEY);
        }
    }
