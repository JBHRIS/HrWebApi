...
namespace JBHR.Att
{
    public partial class FRM27 : JBControls.JBForm
    {
        ...
        private void FRM27_Load(object sender, EventArgs e)
        {
            ...
            SystemFunction.SetComboBoxItems(cbxRoteSalcode, CodeFunction.GetSalCode(), true, false, true);
            SystemFunction.SetComboBoxItems(ptxRote, CodeFunction.GetRote(), true, false, true);
            SystemFunction.SetComboBoxItems(cbxHoliRote, CodeFunction.GetRote(), true, false, true);
