<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmpBaseByUser.ascx.cs"
    Inherits="Employee_EmpBaseByUser" %>
<%@ Register Src="../Account/AccountPictureByUser.ascx" TagName="AccountPicture"
    TagPrefix="uc1" %>
<h3>
    <asp:Label ID="lblBaseData" runat="server" Text="基本資料" meta:resourcekey="lblBaseDataResource1"></asp:Label></h3>
<table width="90%">
    <tr>
