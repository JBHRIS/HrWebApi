...
public partial class MasterPage3_MasterPage : JMasterPage
{
    ...
    protected void RadMenu1_ItemDataBound(object sender, RadMenuEventArgs e)
    {
        if (Context.User.Identity.IsAuthenticated)
        {
            ...
            bool value = (from c in siteMapSalaDrList where e.Item.NavigateUrl.Contains(c.SiteMapUrl) select c).Any();
