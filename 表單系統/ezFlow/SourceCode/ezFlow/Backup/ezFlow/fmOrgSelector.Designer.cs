namespace ezFlow {
	partial class fmOrgSelector {
		...
		private void InitializeComponent() {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(fmOrgSelector));
			...
			this.Name = "fmOrgSelector";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "組織選取器";
			this.Shown += new System.EventHandler(this.fmOrgSelector_Shown);
			this.Load += new System.EventHandler(this.fmOrgSelector_Load);
