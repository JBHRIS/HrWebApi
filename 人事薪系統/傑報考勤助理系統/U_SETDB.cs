...
namespace JBHR
{
    public partial class U_SETDB : JBControls.JBForm
    {
        ...
        private void bnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("請填寫設定檔名稱", Resources.All.DialogTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (textBoxSERVER.Text.Trim().Length == 0)
            {
                MessageBox.Show(Resources.All.SETDBERR1, Resources.All.DialogTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (textBoxDATABASE.Text.Trim().Length == 0)
            {
                MessageBox.Show(Resources.All.SETDBERR2, Resources.All.DialogTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (textBoxUSERID.Text.Trim().Length == 0)
            {
                MessageBox.Show(Resources.All.SETDBERR3, Resources.All.DialogTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            if (textBoxPASSWORD.Text.Trim().Length == 0)
            {
                MessageBox.Show(Resources.All.SETDBERR4, Resources.All.DialogTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            //else
            //{
            //    MessageBox.Show(Resources.All.ConnectionSettingNotFound + "\n" + Resources.All.PlsInsertUSBKey, Resources.All.DialogTitle, MessageBoxButtons.OK, MessageBoxIcon.Warning);
            //}
        }
    }
}