<%@ Page Title="" Language="C#" MasterPageFile="~/MainFlowFormsChk.master" AutoEventWireup="true" CodeBehind="FormEmployChk.aspx.cs" Inherits="Portal.FormEmployChk" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <div class="ibox-content">
        <telerik:RadAjaxPanel runat="server" ID="plMain" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <telerik:RadListView runat="server" ID="lvPerformanceLog" RenderMode="Lightweight" ItemPlaceholderID="Container">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <telerik:RadLabel runat="server" Text='<%# Eval("InsertMan") %>'></telerik:RadLabel>
                        </td>
                        <td>
                            <telerik:RadLabel runat="server" Text='<%# Eval("InsertDate","{0:yyyy/MM/dd HH:mm}") %>'></telerik:RadLabel>
                        </td>
                    </tr>
                </ItemTemplate>
                <EmptyDataTemplate>
            ...
            <asp:Panel runat="server" ID="plPerformance">
                <div class="row form-group">
                    <div class="col-md-12">
                        <label class=" col-form-label">新進人員之學習精神及工作態度、品行等之評核</label>
                        <telerik:RadTextBox runat="server" ID="txtPerformance1" Width="100%" Rows="3" TextMode="MultiLine" CssClass="form-control"></telerik:RadTextBox>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        ...
                        <telerik:RadTextBox runat="server" ID="txtPerformance2" Width="100%" Rows="3" TextMode="MultiLine" CssClass="form-control"></telerik:RadTextBox>
                    </div>
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        ...
                        <telerik:RadTextBox runat="server" ID="txtPerformance3" Width="100%" Rows="3" TextMode="MultiLine" CssClass="form-control"></telerik:RadTextBox>
                    </div>
            ...
            <telerik:RadAjaxPanel runat="server" ID="plResult" Width="100%">
                <div class="row form-group">
                    <div class="col-md-3">
