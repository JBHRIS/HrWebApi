<%@ Page Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true"
    CodeFile="UpBaseCon.aspx.cs" Inherits="HR_UpBaseCon" Title="修改通訊資料" Culture="auto"
            ...
            <td valign="top">
                ...
                <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource1" DefaultMode="Edit"
                    ...
                    <EditItemTemplate>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td style="width: 72%" valign="top">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv_up_GSM" runat="server" ControlToValidate="up_gsm"
                                            ErrorMessage="*Required" ForeColor="Red" ValidationGroup="gcheck" 
                                            Enabled="False"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td svalign="top" style="width: 81px">
                                        <asp:Label ID="Label2" runat="server" Text="E-Mail" SkinID="Notice" ForeColor="Blue"
                                            meta:resourcekey="Label2Resource1"></asp:Label>
                                    </td>
                                    <td valign="top">
                                        <asp:TextBox ID="up_email" runat="server" Width="295px" Text='<%# Bind("EMAIL") %>'
                                            meta:resourcekey="up_emailResource1"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv_up_tel2" runat="server" ControlToValidate="up_tel2"
                                            ErrorMessage="*Required" ForeColor="Red" ValidationGroup="gcheck" 
                                            Enabled="False"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td valign="top" style="width: 81px">
                                        <asp:Label ID="Label10" runat="server" Text="出生地" SkinID="Notice" ForeColor="Blue"
                                            Visible="False" meta:resourcekey="Label10Resource1"></asp:Label>
                                    </td>
                                    <td valign="top">
                                        <asp:TextBox ID="up_born_addr" runat="server" Width="100px" Text='<%# Bind("BORN_ADDR") %>'
                                            Visible="False" meta:resourcekey="up_born_addrResource1"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <a href="#">
                                            <asp:RequiredFieldValidator ID="rfv_CONT_MAN" runat="server" ControlToValidate="CONT_MAN"
                                                ErrorMessage="*Required" ForeColor="Red" ValidationGroup="gcheck" 
                                            Enabled="False"></asp:RequiredFieldValidator>
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <SafiUI:ExtendedDropDownList ID="CONT_REL1" runat="server" DataSourceID="RESqlDataSource1"
                                            DataTextField="REL_NAME" DataValueField="REL_CODE" SelectedValue='<%# Bind("CONT_REL1") %>'
                                            OnDataBound="CONT_REL1_DataBound" meta:resourcekey="CONT_REL1Resource1" ObsoleteValueText="Item archived">
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <a href="#">
                                            <asp:RequiredFieldValidator ID="rfv_CONT_GSM" runat="server" ControlToValidate="CONT_GSM"
                                                ErrorMessage="*Required" ForeColor="Red" ValidationGroup="gcheck" 
                                            Enabled="False"></asp:RequiredFieldValidator>
                                        </a>
                                    </td>
                        ...
                        <fieldset>
                            <legend>
                                <asp:Label ID="lblContace2" runat="server" Text="連絡人2" meta:resourcekey="lblContace2Resource1"></asp:Label></legend>
                            <table width="100%">
                                <tr>
                                    <td style="width: 81px" valign="top">
                                    ...
                                    <td valign="top">
                                        <asp:TextBox ID="CONT_MAN2" runat="server" MaxLength="15" Width="90px" Text='<%# Bind("CONT_MAN2") %>'
                                            meta:resourcekey="CONT_MAN2Resource1"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 81px" valign="top">
                                    ...
                                    <td valign="top">
                                        <SafiUI:ExtendedDropDownList ID="CONT_REL2" runat="server" DataSourceID="RESqlDataSource1"
                                            DataTextField="REL_NAME" DataValueField="REL_CODE" SelectedValue='<%# Bind("CONT_REL2") %>'
                                            OnDataBound="CONT_REL1_DataBound" meta:resourcekey="CONT_REL2Resource1" ObsoleteValueText="Item archived">
                                        </SafiUI:ExtendedDropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td valign="top">
                                        <asp:TextBox ID="CONT_TEL2" runat="server" MaxLength="15" Width="90px" Text='<%# Bind("CONT_TEL2") %>'
                                            meta:resourcekey="CONT_TEL2Resource1"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 81px" valign="top">
                                    ...
                                    <td valign="top">
                                        <asp:TextBox ID="CONT_GSM2" runat="server" MaxLength="15" Width="90px" Text='<%# Bind("CONT_GSM2") %>'
                                            meta:resourcekey="CONT_GSM2Resource1"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </fieldset>
                ...
                <%--              <div class="SilverForm">
                    ...
                    <div class="SilverFormContent" style="color: red">
                        ...
                        <asp:Label ID="lblNoteDetail3" runat="server" Text="3.注意每一次異動修改資料後，HR會產生異動記錄！" meta:resourcekey="lblNoteDetail3Resource1"></asp:Label><br />
                        <asp:Label ID="lblNoteDetail4" runat="server" Text="4.如學歷資料更新，請影印最新學歷證明文件，送交人資部更新存查！"
