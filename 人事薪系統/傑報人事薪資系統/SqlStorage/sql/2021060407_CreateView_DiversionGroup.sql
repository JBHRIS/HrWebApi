/****** Object:  View [dbo].[View_DiversionGroup]    Script Date: 2021/6/9 下午 04:47:00 ******/
SET ANSI_NULLS ON
GO
...
FROM     dbo.DiversionGroup AS dg INNER JOIN
               ...
               dbo.BASETTS AS bs ON b.NOBR = bs.NOBR AND GETDATE() BETWEEN bs.ADATE AND bs.DDATE INNER JOIN
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'View_DiversionGroup'
GO
