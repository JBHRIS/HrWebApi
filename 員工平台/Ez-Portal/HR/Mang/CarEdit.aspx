<%@ Page Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true"
    CodeFile="CarEdit.aspx.cs" Inherits="CarEdit" Title="Untitled Page" Culture="auto"
            ...
            <div style="float: left; width: 800px" runat="server" id="pnlAddForm" visible="false">
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="tbCarId" runat="server" Rows="3" Width="100%">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <telerik:RadTextBox ID="tbLicensePlate" runat="server" Rows="3" Width="100%">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                ...
                <telerik:RadGrid ID="gv" runat="server" AutoGenerateColumns="False" CellSpacing="0"
                    ...
                    <MasterTableView DataKeyNames="Id">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="CarId" FilterControlAltText="Filter CarId column"
                                HeaderText="公務車編號" UniqueName="CarId">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="LicensePlate" FilterControlAltText="Filter LicensePlate column"
                                HeaderText="公務車牌照" UniqueName="LicensePlate">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn DataField="DispBackColor" EmptyDataText="" 
                                FilterControlAltText="Filter DispBackColor column" HeaderText="顏色" 
                                UniqueName="DispBackColor" Visible="False">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn DataField="Color" EmptyDataText="" 
                                FilterControlAltText="Filter Color column" HeaderText="顯示顏色" UniqueName="Color">
                            </telerik:GridBoundColumn>
                        </Columns>
                        <EditFormSettings>
