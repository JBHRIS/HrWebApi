...
namespace JBHR.Sys
{
    public partial class FRMG13 : JBControls.JBForm
    {
        public FRMG13()
        {
            InitializeComponent();
        ...
        private void FRMG13_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dATA_PASSTableAdapter.FillByDATAGROUP(sysDS.DATA_PASS, MainForm.USER_ID, MainForm.COMPANY, MainForm.ADMIN, d1, d2, comboBox1.SelectedValue.ToString());
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show(Resources.Sys.CancelAttendLock, Resources.All.DialogTitle, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                CDataLog.Save(this.Name, MainForm.USER_NAME, DateTime.Now, sysDS.DATA_PASS);
                dATA_PASSTableAdapter.Update(sysDS.DATA_PASS);
