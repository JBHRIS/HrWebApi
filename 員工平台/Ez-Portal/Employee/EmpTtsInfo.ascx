<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmpTtsInfo.ascx.cs" Inherits="Employee_EmpTtsInfo" %>
<h3>
    <asp:Label ID="lblPersonal" runat="server" Text="人事資料" meta:resourcekey="lblPersonalResource1"></asp:Label>
</h3>
<asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="White"
    BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource1"
    Font-Size="Small" ForeColor="Black" GridLines="Vertical" OnDataBinding="DetailsView1_DataBinding"
    Width="90%" OnDataBound="DetailsView1_DataBound" 
    meta:resourcekey="DetailsView1Resource1" style="margin-top: 0px">
    <FooterStyle BackColor="#CCCC99" />
    <RowStyle BackColor="#F7F7DE" Font-Size="Small" />
    <PagerStyle BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Right" />
    <Fields>
        <asp:BoundField DataField="公司名稱" HeaderText="公司名稱" SortExpression="公司名稱" meta:resourcekey="BoundFieldResource1" Visible="false">
            <HeaderStyle Width="100px" />
        </asp:BoundField>
        <asp:BoundField DataField="編制部門代碼" HeaderText="編制部門代碼" SortExpression="編制部門代碼" Visible="False"
            meta:resourcekey="BoundFieldResource2" />
        <asp:BoundField DataField="編制部門" HeaderText="編制部門" SortExpression="編制部門" meta:resourcekey="BoundFieldResource3" />
        <asp:BoundField DataField="成本部門代碼" HeaderText="成本部門代碼" SortExpression="成本部門代碼" Visible="false"
            meta:resourcekey="BoundFieldResource4" />
        <asp:BoundField DataField="成本部門" HeaderText="成本部門" SortExpression="成本部門" 
            meta:resourcekey="BoundFieldResource5" />
        <asp:BoundField DataField="職稱" HeaderText="職稱" SortExpression="職稱" meta:resourcekey="BoundFieldResource6" />
        <asp:BoundField DataField="職等" HeaderText="職等" SortExpression="職等" meta:resourcekey="BoundFieldResource7" />
        <asp:BoundField DataField="員別" HeaderText="員別" SortExpression="員別" meta:resourcekey="BoundFieldResource8" Visible="false" />
        <asp:BoundField DataField="直間接" HeaderText="直間接" SortExpression="直間接" meta:resourcekey="BoundFieldResource9" Visible="false" />
        <asp:BoundField DataField="行事曆" HeaderText="行事曆" SortExpression="行事曆" Visible="False"
            meta:resourcekey="BoundFieldResource10" />
        <asp:BoundField DataField="輪班別" HeaderText="輪班別" SortExpression="輪班別" meta:resourcekey="BoundFieldResource11" Visible="false" />
        <asp:CheckBoxField DataField="主管職" HeaderText="主管職" ReadOnly="True" SortExpression="主管職"
            Visible="False" meta:resourcekey="CheckBoxFieldResource1" />
        <asp:BoundField DataField="工作地" HeaderText="工作地" SortExpression="工作地" Visible="False"
