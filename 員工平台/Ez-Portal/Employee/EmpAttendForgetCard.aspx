<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="EmpAttendForgetCard.aspx.cs" Inherits="EmpAttendForgetCard"
    Title="員工忘刷" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
        ...
        <div id="mainContent">
            <h3>
                <asp:Localize ID="Localize1" runat="server" 
                    meta:resourcekey="Localize1Resource1" Text="忘刷卡統計"></asp:Localize>
            </h3>
            <fieldset>
                <legend>查詢條件</legend>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
            ...
            <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" SkinID="Yahoo" OnPageIndexChanging="GridView2_PageIndexChanging"
                AllowPaging="True" meta:resourcekey="gvResource1">
                <Columns>
                    ...
                    <asp:BoundField DataField="Qty" HeaderText="忘刷次數" 
                        meta:resourcekey="BoundFieldResource8" />
                </Columns>
                <EmptyDataTemplate>
                    <asp:Label ID="lb_empty" Font-Size="Small" runat="server" Font-Bold="True" ForeColor="Red" 
            ...
            <asp:GridView ID="gvSummury" runat="server" AutoGenerateColumns="False" SkinID="Yahoo"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="MinsAmt" HeaderText="忘刷次數" 
