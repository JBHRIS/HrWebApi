...
namespace ezEngineServices.core
{
    public class Service
    {
        ...
        public Service(ezFlowContext dcFlow)
        {
            this.dcFlow = dcFlow;
        }
        ...
        public bool SaveDynamic(int idProcess, string idFlowNode, string idEmp, string idRole = "")
        {
            ...
            if (rFlowNode != null)
            {
                ...
                if (idRole.Length > 0)
                {
                    var rDynamic = (from c in dcFlow.wfDynamics
                    ...
                    if (rDynamic == null)
                    {
                        ...
                        dcFlow.wfDynamics.Add(rDynamic);
        ...
        public bool DeleteDynamic(int idProcess, string idFlowNode)
        {
            ...
            if (rDynamic != null)
                dcFlow.wfDynamics.Remove(rDynamic);
        ...
        {
            var rsDynamic = (from c in dcFlow.wfDynamics
                             where c.idProcess == idProcess
        ...
        public bool FlowStart(int idProcess, string idFlowTree, string idRole_Start, string idEmp_Start, string idRole_Agent = "", string idEmp_Agent = "", bool EmpSameUp = true, CMan Man_Default = null, CMan Man_Agent = null)
        {
            ...
            //如果流程失效，就無法繼續
            var rFlowTree = (from c in dcFlow.FlowTrees
            ...
            var rFlowLink = (from c in dcFlow.FlowLinks
                             where c.FlowTree_id == idFlowTree
            ...
            var rowProcessFlow = (from c in dcFlow.ProcessFlows
            ...
            if (rowProcessFlow == null)
            {
                ...
                dcFlow.ProcessFlows.Add(rowProcessFlow);
            }
            ...
            var rowProcessApView = (from c in dcFlow.ProcessApViews
            ...
            if (rowProcessApView == null)
            {
                ...
                dcFlow.ProcessApViews.Add(rowProcessApView);
            }
            ...
            var rsProcessFlowShare = (from c in dcFlow.ProcessFlowShares
                                      where c.ProcessFlow_id == idProcess
                                      select c).ToList();
            ...
            if (!rsProcessFlowShare.Where(p => p.Emp_id == idEmp_Start).Any())
            {
                ...
                dcFlow.ProcessFlowShares.Add(rowProcessFlowShare);
            }
        ...
        {
            var rProcessFlowShare = (from c in dcFlow.ProcessFlowShares
                                     where c.ProcessFlow_id == idProcess
            ...
            if (rProcessFlowShare == null)
            {
                ...
                dcFlow.ProcessFlowShares.Add(rProcessFlowShare);
                dcFlow.SaveChanges();
            }
        }
        ...
        public bool SetProcessApParm(int iApParmID)
        {
            ...
            if (rProcessApParm != null)
            {
                var rProcessCheck = (from c in dcFlow.ProcessChecks
        ...
        {
            var rCheckAgent = (from c in dcFlow.CheckAgents
            ...
            if (rCheckAgent == null)
            {
                ...
                dcFlow.CheckAgents.Add(rCheckAgent);
            }
        ...
        public bool DelCheckAgent(string sGuid)
        {
            ...
            var r = (from c in dcFlow.CheckAgents
                     where c.Guid == sGuid
                     select c).FirstOrDefault();
            ...
            if (r != null)
            {
                ...
                var rs = (from c in dcFlow.CheckAgentFlowTrees
                ...
                using (TransactionScope scope = new TransactionScope())
                {
                    try
                    {
                        dcFlow.CheckAgentFlowTrees.RemoveRange(rs);
                        dcFlow.CheckAgents.Remove(r);
        ...
        public bool SetEmpAgentDate(string sNobr, DateTime dDateTimeA, DateTime dDateTimeD, string KeyMan = "Sys")
        {
            ...
            if (rEmpAgentDate == null)
            {
                ...
                dcFlow.EmpAgentDates.Add(rEmpAgentDate);
            }
        ...
        public bool DelEmpAgentDate(int AutoKey)
        {
            ...
            var r = (from c in dcFlow.EmpAgentDates
        ...
        {
            var rCheckAgentFlowTree = (from c in dcFlow.CheckAgentFlowTrees
            ...
            if (rCheckAgentFlowTree == null)
            {
                ...
                dcFlow.CheckAgentFlowTrees.Add(rCheckAgentFlowTree);
            }
        ...
        public bool DelCheckAgentFlowTree(int AutoKey)
        {
            ...
            var r = (from c in dcFlow.CheckAgentFlowTrees
                     where c.auto == AutoKey
                     select c).FirstOrDefault();
            ...
            if (r != null)
            {
                using (TransactionScope scope = new TransactionScope())
                {
                    try
                    {
                        dcFlow.CheckAgentFlowTrees.Remove(r);
                        dcFlow.SaveChanges();
        ...
        public bool? WorkFinishAndFlowFinish(int idApParm, bool EmpSameUp = true, CMan Man_Default = null, CMan Man_Agent = null, bool FlowStart = false)
        {
            ...
            if (apParm != null)
            {
                ...
                var rProcess = (from pf in dcFlow.ProcessFlows
        ...
        public void AddMultiFlow(int idProcess, string idSubFlowTree, string idSubInitRole, string idSubInitEmp, string idSubDynamicRole, string idSubDynamicEmp)
        {
            ...
            dcFlow.ProcessMultiFlows.Add(rowProcessMultiFlow);
        ...
        {
            int idProcess = 0;
            var rProcessMultiFlow = (from c in dcFlow.ProcessMultiFlows
        ...
        {
            Dao.EmpDao oEmpDao = new Dao.EmpDao(dcFlow);
        ...
        {
            var r = (from c in dcFlow.wfWebValidates
        ...
        {
            var r = (from c in dcFlow.SysAdmins
                     where c.Emp_id == sNobr
                     select c).FirstOrDefault();
        ...
        {
            var Vdb = (from c in dcFlow.wfForms
        ...
        public List<int> FlowError()
        {
            var Vdb = (from pf in dcFlow.ProcessFlows
                       ...
                       && !(from pn in dcFlow.ProcessNodes where pf.id == pn.ProcessFlow_id select 1).Any())
                       || (!pf.isCancel.Value
                       && !pf.isError.Value
                       && !pf.isFinish.Value    //如果流程正在進行中 但所有node的資料都為true 代表流程已經中斷
                       && (from pn in dcFlow.ProcessNodes where pf.id == pn.ProcessFlow_id select 1).Any()
                       && !(from pn in dcFlow.ProcessNodes where !pn.isFinish.Value && pf.id == pn.ProcessFlow_id select 1).Any())
                       || (!pf.isCancel.Value
                       && !pf.isError.Value
        ...
        public List<int> ProcessFlowSendMail(List<int> lsProcessID, string idEmp = "")
        {
            ...
            foreach (var rProcessID in lsProcessID)
            {
                ...
                var rProcessCheck = (from pn in dcFlow.ProcessNodes
                                     join pc in dcFlow.ProcessChecks on pn.auto equals pc.ProcessNode_auto
                                     join SM in dcFlow.wfSendMails on pn.ProcessFlow_id equals SM.idProcess
                                     where pn.ProcessFlow_id == rProcessID
                                     && pn.isFinish == false
                                     orderby SM.iAutoKey
                                     select pc).FirstOrDefault();

                var rwfSendMail = (from SM in dcFlow.wfSendMails
                ...
                {
                    var rAgent = (from c in dcFlow.Emps
                ...
                foreach (var s in lsSendMail)
                {
                    if (s != "" && s != null)
                    {
                        ...
                        dcFlow.wfSendMails.Add(rSendMail);
                        dcFlow.SaveChanges();
                    }
                }
            }
