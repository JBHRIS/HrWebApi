...
namespace JBHR.TRA
{
	public partial class FRM93 : JBControls.JBForm
	{
		public FRM93()
		{
			InitializeComponent();
        ...
        private void FRM93_Load(object sender, EventArgs e)
		{
            ...
            fullDataCtrl1.CodeColumn = "TRASSCODE.TR_ASNO";//**代碼權限設定**
            fullDataCtrl1.CodeSource = "TRASSCODE";//**代碼權限設定**
		...
		private void fullDataCtrl1_BeforeSave(object sender, JBControls.FullDataCtrl.BeforeEventArgs e)
		{
            ...
            {
                if (GetTrAsno(txtTR_ASNO_DISP.Text) != null)
                {
                    MessageBox.Show("「課程評估代碼」已使用，請重新輸入。", "警告", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtTR_ASNO_DISP.Focus();
                    e.Cancel = true;
                    return;
                }
            }
			...
			if (!e.Cancel)
			{
                ...
                {
                    e.Values["TR_ASNO"] = Guid.NewGuid().ToString();
                }
				e.Values["TEL"] = string.Empty;
				e.Values["key_man"] = MainForm.USER_NAME;
				e.Values["key_date"] = DateTime.Now;
			}
		}
        JBModule.Data.Linq.TRASSCODE GetTrAsno(string TrAsnoDisp)
        {
            JBModule.Data.Linq.HrDBDataContext db = new JBModule.Data.Linq.HrDBDataContext();
            var sql = from a in db.TRASSCODE
                      where a.TR_ASNO_DISP == TrAsnoDisp
                      select a;
