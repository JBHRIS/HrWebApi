<%@ Page Title="" Language="C#" MasterPageFile="~/mpCheck0990119.master" AutoEventWireup="true"
    CodeFile="Check.aspx.cs" Inherits="ShiftShort_Check" %>
                ...
                <tr>
                    <td>
                        <asp:GridView ID="gvAppS" runat="server" AutoGenerateColumns="False" CellPadding="4"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="核准">
                                    <ItemTemplate>
                                ...
                                <asp:BoundField DataField="dDateA" DataFormatString="{0:d}" HeaderText="原日期" SortExpression="dDateA" />
                                <asp:BoundField DataField="sRoteNameA" HeaderText="原班別" SortExpression="sRoteNameA" />
                                <asp:BoundField DataField="dDateB" DataFormatString="{0:d}" HeaderText="換班日" SortExpression="dDateB" />
                                <asp:BoundField DataField="sRoteNameB" HeaderText="換班班別" SortExpression="sRoteNameB" />
