<%@ Page Title="" Language="C#" MasterPageFile="~/Single.Master" AutoEventWireup="true" CodeBehind="LoginAuth.aspx.cs" Inherits="Portal.LoginAuth" %>
    ...
    <div id="form1" class="m-t" role="form">
        <telerik:RadAjaxPanel ID="plMain" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
            ...
            <%--<button
                ...
                data-sitekey="6Lc3d_EcAAAAACEYjbvcoXtVlp2py9Gd_B7Ctb86"
                data-action="verify1"
                data-callback="verifyCallback">
                送出</button>--%>
            <%--<div class="g-recaptcha" data-sitekey="6Lc3d_EcAAAAACEYjbvcoXtVlp2py9Gd_B7Ctb86"></div>

            <telerik:RadButton ID="btnLogin" runat="server" Text="Check Recaptcha" OnClick="btnLogin_Click"></telerik:RadButton>
            <telerik:RadLabel ID="lblmsg1" runat="server" Text="Label"></telerik:RadLabel>--%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script>
        ...
        var uriGAS = 'https://script.google.com/macros/s/AKfycbx2TSWgs5OjHlhqamSudg37TYjLWeW4_youZVC-qZxZw-bBq3ImUspi12WmR1Z3BnBxtA/exec';
