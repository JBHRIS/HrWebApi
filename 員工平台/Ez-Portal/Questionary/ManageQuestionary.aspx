<%@ Page Title="" Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true"
    CodeFile="ManageQuestionary.aspx.cs" Inherits="ManageQuestionary" %>
                    ...
                    <MasterTableView DataKeyNames="Id" AllowSorting="False">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="FillFormDatetimeE" FilterControlAltText="Filter FillFormDatetimeE column"
                                HeaderText="問卷填寫截止時間" UniqueName="FillFormDatetimeE" DataFormatString="{0:yyyy/M/d HHmm}">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridCheckBoxColumn DataField="IsPublished" DataType="System.Boolean" FilterControlAltText="Filter IsPublished column"
                                HeaderText="發佈" UniqueName="IsPublished">
                            ...
                            <telerik:GridCheckBoxColumn DataField="ViewSummaryClosed" DataType="System.Boolean"
                                FilterControlAltText="Filter ViewSummaryClosed column" UniqueName="ViewSummaryClosed"
                                HeaderText="截止後問卷結果">
                            </telerik:GridCheckBoxColumn>
                            <telerik:GridCheckBoxColumn DataField="ViewSummaryOpening" DataType="System.Boolean"
                                FilterControlAltText="Filter ViewSummaryOpening column" UniqueName="ViewSummaryOpening"
                                HeaderText="統計中問卷結果">
                            </telerik:GridCheckBoxColumn>
                            <telerik:GridCheckBoxColumn DataField="IsAnonymous" DataType="System.Boolean" FilterControlAltText="Filter IsAnonymous column"
                                UniqueName="IsAnonymous" HeaderText="匿名">
                            </telerik:GridCheckBoxColumn>
                            <telerik:GridButtonColumn CommandName="cmdDelete" ConfirmText="確認取消該份問卷?" FilterControlAltText="Filter cmdDelete column"
                                Text="取消" UniqueName="cmdDelete">
                            </telerik:GridButtonColumn>
                        </Columns>
                        <EditFormSettings>
                    ...
                    <MasterTableView AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn DataField="DEPT" FilterControlAltText="Filter DEPT column"
                                HeaderText="部門代碼" SortExpression="DEPT" UniqueName="DEPT" ReadOnly="True" FilterControlWidth="50px">
                            </telerik:GridBoundColumn>
