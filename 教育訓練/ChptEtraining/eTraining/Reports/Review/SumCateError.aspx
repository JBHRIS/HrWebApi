<%@ Page Title="各課程別開立矯正措拖通知單統計" Language="C#" MasterPageFile="~/mpTraining.master"
    AutoEventWireup="true" CodeFile="SumCateError.aspx.cs" Inherits="eTraining_Reports_Review_SumCateError" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="False" Font-Names="Verdana"
        ...
        <LocalReport ReportPath="eTraining\Reports\Review\SumCateError.rdlc">
        </LocalReport>
    </rsweb:ReportViewer>
</asp:Content>
