<%@ Page Title="" Language="C#" MasterPageFile="~/MainFlowFormsStd.master" AutoEventWireup="true" CodeBehind="FormAbsApplyByDeptStd.aspx.cs" Inherits="Portal.FormAbsApplyByDeptStd" %>
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="gvAppS">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="lblNotifyMsg" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
                    ...
                    <div class="keyin keyin-border">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-6 col-lg-3">假別：<%# Eval("HolidayName") %></div>
                                    <div class="col-6 col-lg-3">代理人：<%# Eval("AgentEmpName") %></div>
                                    <div class="col-6 col-lg-3">請假時數：<%# Eval("Use") %></div>
                                    <div class="col-6 col-lg-3">單位：<%# Eval("UnitCode") %></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">原因：<%# Eval("Note") %></div>
        ...
        <div class="ibox-content">
            <telerik:RadAjaxPanel ID="plAppS" runat="server">
                <div class="form-group row">
                    <div class="col-md-3">
                        <label class=" col-form-label" style="width: 100%">部門清單</label>
                        <telerik:RadComboBox ID="ddlDept" runat="server" Culture="zh-TW" AllowCustomText="True" Skin="Bootstrap"
                            AutoPostBack="True" EnableVirtualScrolling="True" ItemsPerRequest="10" Filter="Contains"
                            LoadingMessage="載入中…" Width="100%" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged">
                        </telerik:RadComboBox>
                    </div>
                    <asp:Panel runat="server" ID="plName" CssClass="col-md-3">
                        <label class=" col-form-label" style="width: 100%">被申請人姓名</label>
