<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CalRpt1.aspx.cs" Inherits="CalRpt1" %>
...
<body>
    ...
    <div>
		<CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
			...
			ReuseParameterValuesOnRefresh="True" Width="878px" />
		<CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
			<Report FileName="CalRpt1.rpt">
			</Report>
