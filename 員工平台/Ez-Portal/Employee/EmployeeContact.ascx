<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmployeeContact.ascx.cs" Inherits="Employee_EmployeeContact" %>
<h3>
    ...
    CellPadding="4" DataSourceID="SqlDataSource1"
            ...
            <Fields>
                ...
                <asp:BoundField DataField="tel2" HeaderText="戶籍電話" SortExpression="tel2" 
                    meta:resourcekey="BoundFieldResource3" />
                <asp:BoundField DataField="tel1" HeaderText="通訊電話" SortExpression="tel1" 
                    meta:resourcekey="BoundFieldResource4" />
                <asp:BoundField DataField="postcode2" HeaderText="戶籍郵政區號" 
                  SortExpression="postcode2"  Visible="False" 
                    meta:resourcekey="BoundFieldResource5"/>
                <asp:BoundField DataField="addr2" HeaderText="戶籍地址" SortExpression="addr2" 
                    meta:resourcekey="BoundFieldResource6" />
                <asp:BoundField DataField="postcode1" HeaderText="通訊地址區號" 
                  SortExpression="postcode1" Visible="False" 
                    meta:resourcekey="BoundFieldResource7" />
                <asp:BoundField DataField="addr1" HeaderText="通訊地址" SortExpression="addr1" 
