...
namespace JBHR.BLL.Att
{
    public class TimeTableGenerator
    {
        ...
        public void Generate(bool AttendanceGenerate = true)
        {
            ...
            //產生班表
            //var dtTmt = new JBModule.Data.dsAtt.TMTABLEDataTable();
            ...
            JBModule.Data.dsAttTableAdapters.TMTABLE_TMPTableAdapter ad = new JBModule.Data.dsAttTableAdapters.TMTABLE_TMPTableAdapter();
            JBModule.Data.dsAtt.TMTABLE_TMPDataTable tmtt = ad.GetDataByYymm(prevYymm);//取得上個月的設定

            JBModule.Data.dsAtt.TMTABLEDataTable dt = new JBModule.Data.dsAtt.TMTABLEDataTable();
            JBModule.Data.dsAttTableAdapters.TMTABLETableAdapter ad1 = new JBModule.Data.dsAttTableAdapters.TMTABLETableAdapter();
            ...
            foreach (var it in gpSQL)
            {
                ...
                {
                    JBModule.Data.dsAtt.TMTABLE_TMPRow rTmp = tmtt.FindByYYMMROTE(_YYMM, gp.ROTET);//取得範本    
                    ...
                    for (DateTime i = dd1; i <= dd2; i = i.AddDays(1))
                    {
                            ...
                            && rotet.INHOLI != "1")//如果有假日
                        {
                            ...
                            if (rOthcode.Any())
                            {
                                string roteHoli = rOthcode.First().ROTE;
