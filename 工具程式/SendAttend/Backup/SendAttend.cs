...
namespace waferattend
{
    class SendAttend
    {
                    ...
                    {                        
                        ...
                        try
                        {
                            ...
                            if (ConfigurationSettings.AppSettings["TestMail"] == "")
                            {
                                ...
                                SendMail(ConfigurationSettings.AppSettings["TestMail"], date_b + _Subject, html);
        ...
        {
            int i = 0;
            string body = "<font color=blue><BR>出勤異常之同仁請當天完成補單</font><BR>";
