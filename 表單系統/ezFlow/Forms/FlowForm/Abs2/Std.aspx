<%@ Page Title="" Language="C#" MasterPageFile="~/mpStd1021202.master" AutoEventWireup="true" CodeFile="Std.aspx.cs" Inherits="Abs2_Std" %>
                ...
                <td>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <telerik:RadComboBox ID="txtNameAgent2" runat="server" Culture="zh-TW" AllowCustomText="True"
                                    AutoPostBack="True" EnableVirtualScrolling="True" ItemsPerRequest="10" Filter="Contains"
                                    LoadingMessage="載入中…" OnDataBound="txtNameAgent2_DataBound" OnSelectedIndexChanged="txtNameAgent2_SelectedIndexChanged"
                                    OnTextChanged="txtNameAgent2_TextChanged">
                                </telerik:RadComboBox>
                                <asp:Label ID="lblNobrAgent2" runat="server"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <telerik:RadTextBox ID="txtNoteAgent" runat="server" Height="50px" TextMode="MultiLine"
                                    Width="100%" EmptyMessage="請輸入您的交待事項...">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <telerik:RadButton ID="btnAdd" runat="server" Text="新增" Style="top: 0px; left: 0px"
                            ...
                            <Columns>
                                <telerik:GridTemplateColumn FilterControlAltText="Filter TemplateColumn column" UniqueName="TemplateColumn">
                                    <ItemTemplate>
                                        ...
                                        <telerik:RadButton ID="btnUpload" runat="server" CommandArgument='<%# Eval("sGuid") %>'
                                ...
                                <telerik:GridBoundColumn DataField="sAgentName" FilterControlAltText="Filter sAgentName column"
                                    HeaderText="代理人1" SortExpression="sAgentName" UniqueName="sAgentName">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="sAgentName2" FilterControlAltText="Filter sAgentName2 column"
                                    HeaderText="代理人2" SortExpression="sAgentName2" UniqueName="sAgentName2">
                                </telerik:GridBoundColumn>
                            </Columns>
                            <EditFormSettings>
