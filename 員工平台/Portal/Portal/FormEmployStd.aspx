<%@ Page Title="" Language="C#" MasterPageFile="~/MainFlowFormsStd.master" AutoEventWireup="true" CodeBehind="FormEmployStd.aspx.cs" Inherits="Portal.FormEmployStd" %>
        ...
        <telerik:RadAjaxPanel runat="server" ID="plMain" LoadingPanelID="RadAjaxLoadingPanel1">
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    ...
                    <telerik:RadTextBox runat="server" ID="lblExperienced" Enabled="false" CssClass="form-control"  TextMode="MultiLine" Rows="4" Width="100%"></telerik:RadTextBox>
                </div>
            ...
            <telerik:RadListView runat="server" ID="lvSalary" RenderMode="Lightweight" ItemPlaceholderID="Container" OnNeedDataSource="lvSalary_NeedDataSource">
                ...
                <ItemTemplate>
                    <tr>
                        <td><telerik:RadLabel runat="server" ID="SalaryName" Text='<%# Eval("SalName") %>'></telerik:RadLabel></td>
                        <td><telerik:RadLabel runat="server" ID="Amount" Text='<%# Eval("Amount") %>'></telerik:RadLabel></td>
                    </tr>
                </ItemTemplate>
                <EmptyDataTemplate>
                    目前並無任何薪資資料
