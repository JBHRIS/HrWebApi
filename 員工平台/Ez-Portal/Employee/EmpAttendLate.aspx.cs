...
public partial class EmpAttendLate : JBWebPage
{
    const string SESSION_SUMMURY_TABLE = "Mang_AttendLate_Summury";
    ...
    void GetData()
    {
        ...
        attendList.AddRange(attendRepo.GetAttendLateByEmpDateRange_Dlo(Juser.Nobr, rdpBdate.SelectedDate.Value, rdpEdate.SelectedDate.Value));
