...
{
    class FormsAppAppointForHRVdb
    {
    }
    
    public class FormsAppAppointForHRConditions : DataConditions
    {
    }
    public class FormsAppAppointForHRApiRow : StandardDataBaseApiRow
    {
    ...
    public class FormsAppAppointForHRRow
    {
