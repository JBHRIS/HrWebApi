                ...
                <table>
                    <tr>
                        <td valign="top" width="40%">
                            ...
                            <br />
                            <asp:CheckBox ID="cbxIsRequired" runat="server" Text="必填" />
                            <br />
                            <asp:Label ID="Label1" runat="server" Text="最小字數："></asp:Label>
                            <telerik:RadTextBox ID="rtbxMinCharCount" Runat="server">
                            </telerik:RadTextBox>
                            <br />
            ...
            <MasterTableView DataKeyNames="Id">
                ...
                <Columns>
                    ...
                    <telerik:GridCheckBoxColumn DataField="IsRequired"
                        FilterControlAltText="Filter IsRequired column" HeaderText="必填"
                    ...
                    <telerik:GridBoundColumn DataField="MinCharCount" DataType="System.Int32"
                        FilterControlAltText="Filter MinCharCount column" HeaderText="最小字數"
                        UniqueName="MinCharCount">
                    </telerik:GridBoundColumn>
                </Columns>
                <EditFormSettings>
                    <EditColumn FilterControlAltText="Filter EditCommandColumn column">
