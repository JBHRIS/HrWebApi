<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmpFamilyInfo.ascx.cs" Inherits="Employee_EmpFamilyInfo" %>
<h3>
    <asp:Label ID="lblFamilyInfo" runat="server" Text="眷屬資料" 
        meta:resourcekey="lblFamilyInfoResource1"></asp:Label>
        </h3>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="LightGoldenrodYellow"
        BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataSourceID="SqlDataSource1"
        Font-Size="Small" ForeColor="Black" GridLines="None" Width="90%" 
        OnRowDataBound="GridView1_RowDataBound" 
    meta:resourcekey="GridView1Resource2">
        <Columns>
            <asp:BoundField DataField="關係" HeaderText="關係" SortExpression="關係" 
                meta:resourcekey="BoundFieldResource9" />
            <asp:BoundField DataField="姓名" HeaderText="姓名" SortExpression="姓名" 
                meta:resourcekey="BoundFieldResource10" />
            <asp:BoundField DataField="身份證" HeaderText="身份證" SortExpression="身份證" 
                meta:resourcekey="BoundFieldResource11" Visible="False" />
            <asp:BoundField DataField="出生日" DataFormatString="{0:yyyy/MM/dd}" HeaderText="出生日期"
                HtmlEncode="False" SortExpression="出生日" 
                meta:resourcekey="BoundFieldResource12" />
            <asp:CheckBoxField DataField="所得稅扶養親屬" HeaderText="所得稅扶養親屬" 
                SortExpression="所得稅扶養親屬" Visible="False" 
                meta:resourcekey="CheckBoxFieldResource8" />
            <asp:CheckBoxField DataField="附加健保" HeaderText="附加健保" SortExpression="附加健保" 
                Visible="False" meta:resourcekey="CheckBoxFieldResource9" />
            <asp:CheckBoxField DataField="外籍眷屬" HeaderText="外籍眷屬" SortExpression="外籍眷屬" 
                Visible="False" meta:resourcekey="CheckBoxFieldResource10" />
        </Columns>
...
<asp:GridView ID="GridView2" runat="server" 
      AutoGenerateColumns="False" BackColor="LightGoldenrodYellow"
        ...
        Font-Size="Small" ForeColor="Black" GridLines="None" Width="90%" 
      OnDataBound="GridView2_DataBound" Visible="False" 
        meta:resourcekey="GridView2Resource2" 
        ...
        <Columns>
            ...
            <asp:CheckBoxField DataField="所得稅扶養親屬" HeaderText="所得稅扶養親屬" 
              SortExpression="所得稅扶養親屬" Visible="False" 
                meta:resourcekey="CheckBoxFieldResource11" />
            <asp:CheckBoxField DataField="附加健保" HeaderText="附加健保" SortExpression="附加健保" 
                meta:resourcekey="CheckBoxFieldResource12" ReadOnly="True" />
            <asp:CheckBoxField DataField="附加團保" HeaderText="附加團保" SortExpression="附加團保" 
                meta:resourcekey="CheckBoxFieldResource13" ReadOnly="True" />
            <asp:CheckBoxField DataField="不顯示於主管查詢" HeaderText="不顯示於主管查詢" 
                SortExpression="不顯示於主管查詢" Visible="False" 
                meta:resourcekey="CheckBoxFieldResource14" />
        </Columns>
        <FooterStyle BackColor="Tan" />
        <PagerStyle BackColor="PaleGoldenrod" ForeColor="DarkSlateBlue" HorizontalAlign="Center" />
        <SelectedRowStyle BackColor="DarkSlateBlue" ForeColor="GhostWhite" />
