<%@ Page Language="C#" MasterPageFile="~/NoteMasterPage.master" AutoEventWireup="true"
    CodeFile="EmpOtSelect1.aspx.cs" Inherits="Mang_EmpOtSelect1" Title="Untitled Page"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
        ...
        <uc:EmpDeptQS runat="server" ID="ucEmpDeptQS" />
            ...
            <h3>
                <asp:Label ID="lblEmpOT" runat="server" Text="員工超時統計" meta:resourcekey="lblEmpOTResource1"></asp:Label></h3>
            <fieldset>
                <legend>
                    <asp:Label ID="lblSearch" runat="server" Text="資料查詢" meta:resourcekey="lblSearchResource1"></asp:Label></legend>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
            ...
            <asp:SqlDataSource ID="HR_Portal_EmpInfoSqlDataSource" runat="server" 
            ConnectionString="<%$ ConnectionStrings:HRSqlServer %>" SelectCommand="SELECT NOBR, NAME_C,NAME_AD, INDT,
    DEPT, D_NAME, JOB, JOB_NAME, EMPCD, EMPDESCR, MANG, DI FROM HR_Portal_EmpInfo WHERE
    (DEPT = @Dept) ORDER BY INDT">
                <SelectParameters>
