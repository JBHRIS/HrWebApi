 ...
 * 檔案路徑：~\Customer\JBHR2\人事薪系統\傑報人事薪資系統\Reports\AttForm\ZZ2Z.cs
 * 功能用途：
 *  用於產出員工出勤明細表
 * 
 * 版本記錄：
 ...
 * ======================================================================================================
 * 
 * 最後修改：Daniel Chih (0492) - 2021/05/25
 */
...
namespace JBHR.Reports.AttForm
{
    public partial class ZZ2Z : JBControls.JBForm
    {
        ...
        private void ZZ2Z_Load(object sender, EventArgs e)
        {
            ...
            //新增【部門匯總（全勤獎金）】- Added By Daniel Chih - 2021/05/25
            if (MainForm.COMPANY_NAME == "寶齡富錦生技股份有限公司"
                        || MainForm.COMPANY_NAME == "寶齡全公司"
                        || MainForm.COMPANY_NAME == "正峰化學製藥股份有限公司")
            {
                report_type.Items.Add(new ListItem("部門匯總（全勤獎金）", "check_BPBF_Report"));
            }
        ...
        private void Create_Report_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool printpage = print_page.Checked;
                bool _IntervalHrs = IntervalHrs.Checked;
                bool _No_Dept_Sum = No_Dept_Sum.Checked;

                bool check_BPBF = false;
                ...
                //判斷是否為寶齡獨有報表
                if (report_type.SelectedItem.ToString().Trim() == "部門匯總（全勤獎金）")
                {
                    check_BPBF = true;
                    ...
                    zz2z1_report = new ZZ2Z1_Report(nobrb, nobre, deptb, depte, deptsb, deptse, joblb, joble, dateb, datee, yymmb, yymme, empb, empe, compb, compe, workb, worke, Responsibilityb, Responsibilitye, data_report, _exportexcel, _No_Dept_Sum, MainForm.COMPANY_NAME, MainForm.COMPANY, check_BPBF);
                    zz2z1_report.Show();
