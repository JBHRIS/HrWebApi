<%@ Page Title="" Language="C#" MasterPageFile="~/MainFlowFormsChk.master" AutoEventWireup="true" CodeBehind="FormOvtChk2.aspx.cs" Inherits="Portal.FormOvtChk2" %>
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col col-xs-6">
                                            <span>開始日期：<telerik:RadLabel ID="lblDateB" runat="server" Text='<%# Eval("DateB","{0:yyyy/MM/dd}") %>'></telerik:RadLabel></span><br>
                                            <span>開始時間：<telerik:RadLabel ID="lblTimeB" runat="server" Text='<%# Eval("TimeB") %>'></telerik:RadLabel></span><br>
                                            <%--<span>開始日期：<%# Eval("DateB","{0:yyyy/MM/dd}") %></span><br>
                                            <span>開始時間：<%# Eval("TimeB") %></span>--%>
                                        </div>

                                        <div class="col col-xs-6">
                                            <span>結束日期：<telerik:RadLabel ID="lblDateE" runat="server" Text='<%# Eval("DateE","{0:yyyy/MM/dd}") %>'></telerik:RadLabel></span><br>
                                            <span>結束時間：<telerik:RadLabel ID="lblTimeE" runat="server" Text='<%# Eval("TimeE") %>'></telerik:RadLabel></span><br>
