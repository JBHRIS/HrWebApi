...
using Repo;
public partial class UC_ApplyCourse : System.Web.UI.UserControl
{
    ...
    protected void Gv_ItemDataBound(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            if (hl != null)
            {
                hl.NavigateUrl = "~/eTraining/Staff/CourseDetail.aspx?ClassID="+e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["iAutoKey"].ToString();
            }
        }        
    }
