...
namespace JBHR.Bas
{
    public partial class FRM11P : JBControls.JBForm
    {
        public FRM11P()
        {
            InitializeComponent();
        ...
        private void FRM11M_Load(object sender, EventArgs e)
        {
            ...
            fullDataCtrl1.DataAdapter = doorGuardTableAdapter;
            ...
            fullDataCtrl1.CodeColumn = "DoorGuard.CODE";//**代碼權限設定**
            fullDataCtrl1.CodeSource = "DoorGuard";//**代碼權限設定**
        }
