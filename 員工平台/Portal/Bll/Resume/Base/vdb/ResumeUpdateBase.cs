...
{ 
    class ResumeUpdateBaseVdb
    {
    }
    public class ResumeUpdateBaseConditions : DataConditions
    {
    ...
    public class ResumeUpdateBaseApiRow : StandardDataBaseApiRow
    {

    }
    public class ResumeUpdateBaseRow
    {
    }
}