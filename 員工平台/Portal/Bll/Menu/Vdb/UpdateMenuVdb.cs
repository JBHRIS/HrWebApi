...
{
  public  class UpdateMenuVdb
    {
    }

    public class UpdateMenuConditions : DataConditions
    {
    ...
    public class UpdateMenuApiRow : StandardDataBaseApiRow
    {
        public string result { get; set; }
    }

    public class UpdateMenuRow : StandardDataRow
    {
