...
namespace JBTools.Extend
{
    public static class extCombobox
    {
        public static void SetComboBoxItems(this System.Windows.Forms.ComboBox cbx, Dictionary<string, string> data)
        {
            SetComboBoxItems(cbx, data, false, true, true);
        }
        public static void SetComboBoxItems(this System.Windows.Forms.ComboBox cbx, Dictionary<string, string> data, bool WithNull, bool enable)
        {
            SetComboBoxItems(cbx, data, WithNull, enable, true);
        }
        public static void SetComboBoxItems(this System.Windows.Forms.ComboBox cbx, Dictionary<string, string> data, bool WithNull)
        {
            SetComboBoxItems(cbx, data, WithNull, false, true);
        }
        public static void SetComboBoxItems(this System.Windows.Forms.ComboBox cbx, Dictionary<string, string> data, bool WithNull, bool enable, bool AutoCompleted)
        {
