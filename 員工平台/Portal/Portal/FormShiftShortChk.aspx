<%@ Page Title="" Language="C#" MasterPageFile="~/MainFlowFormsChk.master" AutoEventWireup="true" CodeBehind="FormShiftShortChk.aspx.cs" Inherits="Portal.FormShiftShortChk" %>
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col col-xs-12">
                                            <span><telerik:RadLabel runat="server" ID="lblReasonDic" Text="原因" ></telerik:RadLabel>：<%# Eval("Note") %></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1">
