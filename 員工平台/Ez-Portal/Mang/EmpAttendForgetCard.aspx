<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" CodeFile="EmpAttendForgetCard.aspx.cs" Inherits="Mang_EmpAttendForgetCard"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
        ...
        <uc:EmpDeptQS runat="server" ID="ucEmpDeptQS" />
            ...
            <h3>
                <asp:Label ID="lblHeader" runat="server" Text="員工忘刷卡查詢" 
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
            ...
            SkinID="Yahoo" OnPageIndexChanging="GridView2_PageIndexChanging"
                AllowPaging="True" meta:resourcekey="gvResource1" Width="100%">
                <Columns>
