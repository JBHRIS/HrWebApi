...
namespace Portal
{
    public partial class FormAbsWithApiStd : WebPageBase
    {
        ...
        public void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var rData in rAbsenceData)
                {
                    ...
                    var rsFormsAppAbs = new FormsAppAbs()
                    {
                        ...
                        RoleId = rEmpS.RoleId,
                        DateTimeB = rData.DateB,
                        DateTimeE = rData.DateE,
                        DateB = new DateTime(rData.DateB.Year, rData.DateB.Month, rData.DateB.Day),
                        DateE = new DateTime(rData.DateE.Year, rData.DateE.Month, rData.DateE.Day),
                        TimeB = rData.TimeB,
                        TimeE = rData.TimeE,
                        HolidayCode = rData.Hcode,
                        HolidayName = rHcode.NameC,
                        Use = rData.Use,
                        Balance = iBalance,
                        UnitCode = rData.UnitCode,
