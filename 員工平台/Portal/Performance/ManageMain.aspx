<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ManageMain.aspx.cs" Inherits="Performance.ManageMain" %>
                    ...
                    <div class="ibox-content">
                        <telerik:RadAjaxPanel ID="plSearch" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 ">
                                    <telerik:RadDropDownList ID="ddlType" runat="server" AutoPostBack="true"                                        OnSelectedIndexChanged="ddlType_SelectedIndexChanged" Skin="Bootstrap" />
                                </div>
                            </div>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>考核<br>
                                                    年月</th>
                                                <th>員工<BR>類別</th>
                                                <th data-hide="phone,tablet">產生<br>
                                                    基準日</th>
                                                <th data-hide="phone,tablet">開始日</th>
                                                <th>結束日</th>
                                                <th data-hide="phone,tablet">部門<br>
                                                    考核數</th>
                                                <th data-hide="phone,tablet">員工<br>
                                                    考核人數</th>
                                        ...
                                        <td>
                                            <telerik:RadButton ID="btnEdit" runat="server" Text="編輯" CommandName="Edit" CommandArgument='<%# Eval("AutoKey") %>' CssClass="btn-white btn btn-xs" />
                                                ...
                                                <ul class="dropdown-menu float-right">
                                                    <li><telerik:RadButton ID="btnMainDept" runat="server" Text="部門調整" CommandName="MainDept" CommandArgument='<%# Eval("AutoKey") %>' CssClass="btn-white btn btn-xs" /></li>
                                                    <li><telerik:RadButton ID="btnMailSend" runat="server" Text="發信通知" CommandName="MailSend" CommandArgument='<%# Eval("AutoKey") %>' CssClass="btn-white btn btn-xs "   OnClientClicking="ExcuteConfirm" /></li>
                                                    <li><telerik:RadButton ID="btnReminder" runat="server" Text="催簽通知" CommandName="Reminder" CommandArgument='<%# Eval("AutoKey") %>' CssClass="btn-white btn btn-xs"   OnClientClicking="ExcuteConfirm" /></li>
                                                    <li><telerik:RadButton ID="btnDelete" runat="server" Text="刪除" CommandName="Delete" CommandArgument='<%# Eval("AutoKey") %>' CssClass="btn-white btn btn-xs"   OnClientClicking="ExcuteConfirm" /></li>
                                                </ul>
                                        </td>
                                    </tr>
                                </ItemTemplate>
