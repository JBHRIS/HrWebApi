...
namespace JBHR.Att
{
    ...
    public partial class FRM23 : JBControls.JBForm
    {
        ...
        private void FRM23_Load(object sender, EventArgs e)
        {
            ...
            acg.CheckParameterAndSetDefault("CW7SW", "未七休一排班檢核", "false", "是否開啟未七休一排班檢核", "ComboBox", "select 'True' value , 'True' union select 'False', 'False'", "String");
            acg.CheckParameterAndSetDefault("CITSW", "排班間隔檢核", "false", "是否開啟排班間隔11小時檢核", "ComboBox", "select 'True' value , 'True' union select 'False', 'False'", "String");
