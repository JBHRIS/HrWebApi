...
{
    public class ResumeEducationsVdb
    {

    }
  
    public class ResumeGetEducationsConditions : DataConditions
    {

    }
    public class ResumeGetEducationsApiRow : StandardDataBaseApiRow
    {

    }
    public class ResumeGetEducationsRow
    {
