<%@ Page Language="C#" MasterPageFile="~/MasterPage_OnlyContent.master" AutoEventWireup="true" CodeFile="FlowMonitor.aspx.cs" Inherits="FlowMonitor" Title="ezClient v1.0" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<asp:RadioButtonList ID="rblMenu" runat="server" AutoPostBack="True" Font-Size="Smaller"
    ...
    <asp:Label ID="lblDateE" runat="server" Visible="False"></asp:Label>
	...
	<asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="False" DataKeyNames="ProcessFlow_id"
		...
		<Columns>
			...
			<asp:BoundField DataField="Emp_name_Check" HeaderText="處理者姓名" SortExpression="Emp_name_Check">
				<ItemStyle HorizontalAlign="Center" />
		...
		Width="100%" EnableModelValidation="True">
			...
			<asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}"
				...
				<SelectParameters>
					<asp:ControlParameter ControlID="lblNobr" Name="Emp_id" PropertyName="Text" 
                        Type="String" />
                    <asp:ControlParameter ControlID="lblDateB" DefaultValue="" Name="dateB" 
                        PropertyName="Text" Type="DateTime" />
                    <asp:ControlParameter ControlID="lblDateE" Name="dateE" PropertyName="Text" 
                        Type="DateTime" />
				</SelectParameters>
			</asp:ObjectDataSource>
