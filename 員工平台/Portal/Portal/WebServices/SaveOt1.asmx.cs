...
namespace Portal.WebServices
{
    ...
    public class SaveOt1 : System.Web.Services.WebService
    {
        ...
        public bool Run(int ID)
        {
            ...
            foreach (var rAppS in rsAppS)
            {
                ...
                if (rAppS.Sign)
                {
                    int iPass = oOtDao.Ot1Save(rAppS.EmpId, rAppS.OtCateCode, rAppS.DateB,
                  rAppS.DateB, rAppS.TimeB, rAppS.TimeE, rAppS.Use, rAppS.OtrcdCode,
                  rAppS.RoteCode, rAppS.DeptsCode, "W04", rAppS.Note, rAppM.EmpName, rAppS.ProcessID);
