...
namespace JBAppService.Api.Dal.Implement.App.EEP
{
    public class CardAppDetailsHandler : ICardAppDetailsHandler
    {
        private AppDBContext _AppDBContext;
        private JBEEPContext _JBEEPContext;

        public CardAppDetailsHandler(AppDBContext AppDBContext, JBEEPContext JBEEPContext)
        {
            _AppDBContext = AppDBContext;
            _JBEEPContext = JBEEPContext;
        }
        ...
        public List<CardRowDataDto> GetCardDetail(string Url, string Nobr, DateTime BDate, DateTime EDate, int PageRow = 20, int PageNumber = 1)
        {
            ...
            try
            {
                ...
                BaseInfoDto = (from u in _JBEEPContext.HRM_BASE_BASE
                ...
                result = (from c in _JBEEPContext.HRM_ATTEND_CARD_DATA_TEMP
        ...
        public int SaveCardDetails(SaveCardAppDetailsDto Dto, bool NotTran, string Code)
        {
            ...
            try
            {
                ...
                _AppDBContext.CardAppDetails.Add(Detail);
                ...
                _JBEEPContext.HRM_ATTEND_CARD_DATA_TEMP.Add(mCard);
                _JBEEPContext.SaveChanges();
            }
            catch (Exception ex)
            {
            }
        ...
        public bool SaveCardMsg(SaveCardAppDetailsDto dto, bool notTran, string code)
        {
            ...
            var Data = (from c in _JBEEPContext.HRM_ATTEND_CARD_DATA_TEMP
