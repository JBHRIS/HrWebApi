<%@ Page Title="" Language="C#" MasterPageFile="~/mpStd0990111.master" AutoEventWireup="true"
    CodeFile="Std1.aspx.cs" Inherits="Abs_Std1" %>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:DropDownList ID="ddlHcode" runat="server" AutoPostBack="True" 
                                        ...
                                        OnSelectedIndexChanged="ddlHcode_SelectedIndexChanged" 
                                    ...
                                    <asp:Label ID="lblHcode" runat="server">公出</asp:Label>
                                </td>
                                <td align="center">
                                ...
                                <td align="center">
                                    ...
                                    <asp:TextBox ID="txtAgentName" runat="server" AutoPostBack="True" 
                                        ...
                                        ValidationGroup="fv"></asp:TextBox>
                                    <asp:Label ID="lblAgentNobr" runat="server" Visible="False"></asp:Label><br />
                                    ※可輸入工號或姓名(可跨部門)
                                </td>
                                <td align="center">
